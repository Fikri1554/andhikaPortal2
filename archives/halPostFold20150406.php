	...
	for($i=1; $i<=$jmlFilePost; $i++)
	{
		...
		$html.= "		<table cellpadding=\"0\" cellspacing=\"5\" width=\"100%\" class=\"formInput\" border=\"0\">
						...
						<tr>
							...
							<td>File upload</td>
							<td height=\"20\">
								<input type=\"file\" class=\"elementDefault\" name=\"fileUpload_".$i."\" id=\"fileUpload_".$i."\" style=\"width:310px;\" onChange=\"pilihUpload('".$i."');\" title=\"Choose File from LocalDisk\">
							</td>
						</tr>
						<tr valign=\"top\">
							...
							<td width=\"25%\">Name</td>
							<td width=\"65%\">
								<input type=\"text\" class=\"elementDefault\" id=\"nmFile_".$i."\" name=\"nmFile_".$i."\" style=\"width:310px;height:28px;\" onFocus=\"cekNmFile();\" onKeyUp=\"cekNmFile();\">
							</td>
						</tr>
...
if($halamanPost == "chooseAct2")
{
	...
	$btnActOnProgress = "<button type=\"button\" class=\"btnStandarKecil\" onMouseOver=\"this.className='btnStandarKecilHover'\" onMouseOut=\"this.className='btnStandarKecil'\" id=\"btnChooseAct\" onClick=\"tampilSelection('typeAct1', 'ajaxInput1');tampilSelection('typeAct2', 'ajaxInput2');document.getElementById('statusBtnChooseAct').value='teksAct';\" style=\"width:109px;height:28px;\" title=\"Type a New Activity\">
                            <table class=\"fontBtnKecil\" onMouseOver=\"this.className='fontBtnKecilHover'\" onMouseOut=\"this.className='fontBtnKecil'\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" height=\"100%\">
                            <tr>
...
{
	$activityPost = $_POST['activity'];
	$menuActOnProgress = "<input type=\"text\" class=\"elementDefault\" id=\"activity\" name=\"activity\" style=\"width:99%;height:28px;\" value=\"".$activityPost."\">";					
	echo $menuActOnProgress;
}

if($halamanPost == "typeAct2")
{
	$menuActOnProgress = "<button type=\"button\" class=\"btnStandarKecil\" onMouseOver=\"this.className='btnStandarKecilHover'\" onMouseOut=\"this.className='btnStandarKecil'\" id=\"btnChooseAct\" onClick=\"tampilSelection('chooseAct1', 'ajaxInput1');tampilSelection('chooseAct2', 'ajaxInput2');document.getElementById('statusBtnChooseAct').value='menuAct';\" style=\"width:127px;height:28px;\" title=\"Choose Previous Activity\">
                            <table class=\"fontBtnKecil\" onMouseOver=\"this.className='fontBtnKecilHover'\" onMouseOut=\"this.className='fontBtnKecil'\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" height=\"100%\">
                            <tr>
...
if($halamanPost == "typeAct3")
{
	...
	$menuActOnProgress = "<input type=\"text\" class=\"elementDefault\" id=\"activity\" name=\"activity\" style=\"width:99%;height:28px;\" value=\"".$activityPost."\" ".$readOnlyActPost.">";					
	echo $menuActOnProgress;
}
...
{
	$activityPost = $_POST['activity'];
	$btnActOnProgress = "<button type=\"button\" class=\"btnStandarKecil\" onMouseOver=\"this.className='btnStandarKecilHover'\" onMouseOut=\"this.className='btnStandarKecil'\" id=\"btnChooseAct\" onClick=\"tampilSelection('typeAct3', 'ajaxInput1');tampilSelection('typeAct4', 'ajaxInput2');document.getElementById('statusBtnChooseAct').value='teksAct';\" style=\"width:109px;height:28px;\" title=\"Type a New/Edit Activity\">
                            <table class=\"fontBtnKecil\" onMouseOver=\"this.className='fontBtnKecilHover'\" onMouseOut=\"this.className='fontBtnKecil'\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" height=\"100%\">
                            <tr>
                            	<td align=\"center\"><img src=\"../../picture/Pencil-blue-32.png\" height=\"20\"/> </td>
                                <td align=\"center\">Type Activity</td>
