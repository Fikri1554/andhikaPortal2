<?php
// $useragent=$_SERVER['HTTP_USER_AGENT'];print_r($useragent);exit;
...
if($userIdLogin != "")
{
	...
	//{
	//	$tpl = new myTemplate("templates/halUtamaSudahLoginTes.html");
	//}
}
...
if($userIdLogin != "")
{
	$tpl->AssignInclude("CONTENT_TENGAH","templates/halArchives.html");//print_r("<br><br><br>=> ".$aksiPost);
	$tpl->AssignInclude("CONTENT_BAWAH","templates/halSelectButton.html");
	// if($aksiPost == "closeMapNya")
	// {
	// 	$tpl->AssignInclude("CONTENT_BAWAH","templates/halSelectButton.html");
	// }else{
	// 	$tpl->AssignInclude("CONTENT_BAWAH","templates/halViewMap.html");
	// }
	// $tpl->AssignInclude("CONTENT_BAWAH","templates/halSelectButton.html");
	// $tpl->AssignInclude("CONTENT_BAWAH","templates/halViewMap.php");	
	//**********************************************************
...
if($userIdLogin != "")
{
	...
	//$tpl->Assign("tesGol", $CEmployee->gol($userEmpNo));
}
...
if($aksiGet == "openSubordinateDailyAct" || $aksiGet == "openSubordinateDailyActBalik")
{
	...
	$tpl->Assign("srcMyFolder", "templates/halSelectButton.php?aksi=".$aksiGet."&empNo=".$empNoGet."&userIdSelect=".$CLogin->detilLoginByEmpno($empNoGet, "userid"));
}
...
if($aksiGet == "dailyAct")
{
	...
	$tpl->Assign("srcMyFolder", "templates/halSelectButton.php?aksi=".$aksiGet."&empNo=".$userEmpNo."&userIdSelect=".$userIdLogin);
}
