...
{ // 6-weeks range
	...
	{ // 7 days a week
		...
		$sCalTblRows .= '<td class="'.$sClass.'" onMouseOver="parent.showJobList(\'popUpJobList\', \''.$isiJobList.'\', \'1\')" onMouseOut="parent.showJobList(\'popUpJobList\', \'\', \'0\')"><a href="javascript: void(0)" '.$onClick.'>';
