...
{
	$ide = $_GET['ide'];
	$foldSub = $CFolder->detilFold($ide, "foldsub");
...
<form name="formDetail" method="post" action="halDetailOwnShare.php">
...
<form name="formAuthor" method="post" action="halDetailOwnShare.php">
    <input type="hidden" id="foldSub" name="foldSub" value="<?php echo $foldSub; ?>" />
    <input type="hidden" id="ide" name="ide" value="<?php echo $ide; ?>" />
...
<tr valign="top">
	<td class="tdMyFolder" bgcolor="#FFFFFF" height="65" valign="middle" colspan="2">&nbsp;
    	<button class="btnStandarKecil" type="button" style="width:90px;height:55px;" onClick="parent.exit();" title="Close Own Shared Folder Detail Window">
        ...
        &nbsp;
        <button class="btnStandarKecil" type="button" onClick="formDetail.submit();" style="width:90px;height:55px;" title="This Own Shared Folder Detail Window">
            <table width="100%" height="100%">
              <tr>
        ...
        &nbsp;
        <button class="btnStandarKecil" type="button" onClick="formAuthor.submit();" style="width:120px;height:55px;" title="Go to this Own Shared Folder Permission Window">
            <table width="100%" height="100%">
              <tr>
