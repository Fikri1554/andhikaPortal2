...
/*"fromtime:".$fromTime."-totime:".$toTime."-activity:".$activity."-relatedinfo:".$relatedInfo."-status:".$statusAct."".$statusChange."-datefinish:".$dateFinish."-referIdActivity:".$idActivityOnProgress."-problemIdent:".$problemIdent."-corrective:".$corrective."-kpiNumber:".$kpiNumber."-responComment:".$responComment;*/
	$CKoneksi->mysqlQuery("UPDATE tblactivity SET fromtime = '".$fromTime."', totime = '".$toTime."', activity = '".$activity."', relatedinfo = '".$relatedInfo."', status = '".$statusAct."' ".$statusChange.", datefinish = '".$dateFinish."', referidactivity = '".$idActivityOnProgress."', problemident = '".$problemIdent."', corrective = '".$corrective."', kpinumber = '".$kpiNumber."', responcomment = '".$responComment."', updusrdt = '".$CPublic->userWhoAct()."' WHERE idactivity = '".$idactivityGet."' AND deletests=0;");
	$CHistory->updateLog($userIdLogin, "Rubah Daily Activity (idactivity = <b>".$idactivityGet."</b>, Date = <b>".$dateActGet."</b>, From time = <b>".$fromTime."</b>, To time = <b>".$toTime."</b>, Activity = <b>".$activity."</b>, Related Information = <b>".$relatedInfo."</b>, Status = <b>".$statusAct."</b>, Refer Id Activity = <b>".$idActivityOnProgress."</b>, Problem identification = <b>".$problemIdent."</b>, Corrective = <b>".$corrective."</b>, KPI Number = <b>".$kpiNumber."</b>)");
}
...
<tr valign="top">
    <td class="tdMyFolder" bgcolor="#FFFFFF" colspan="2" align="center" valign="top" width="100%">
    	<div style="width:890px;height:459px;overflow:scroll;overflow-x: hidden;top: expression(offsetParent.scrollTop);">
            ...
            <tr valign="top">
                <td align="center" valign="top" height="130">
                    ...
                    <tr valign="top">
                        ...
                        <td width="55%">
                        From&nbsp;&nbsp;&nbsp;
                        <input type="text" class="elementDefault" id="fromTime" name="fromTime" style="width:50px;height:28px;" value="<?php echo $fromTime; ?>">
                        &nbsp;&nbsp;&nbsp;&nbsp;To&nbsp;&nbsp;&nbsp;
                        <input type="text" class="elementDefault" id="toTime" name="toTime" style="width:50px;height:28px;" value="<?php echo $toTime; ?>">
                        </td>
                        <td width="15%">&nbsp;</td>
                    </tr>
                    <tr valign="top">
                        ...
                        ?>
                        <input type="text" class="elementDefault" id="activity" name="activity" style="width:99%;height:28px;" value="<?php echo $CPublic->konversiQuotes1($activity); ?>" <?php echo $readOnlyAct; ?>></td>
                        ...
                        <?php
							...
							if($referIdActivity != 00000000000)
							{
								...
								$menuActOnProgress= "";
								$nilaiMenu = "";
								$menuActOnProgress.="<select class=\"elementMenu\" id=\"activityOnProgress\" name=\"activityOnProgress\" style=\"width:99%;\" title=\"Choose Your Activity\">";
                        ...
                        <?php
							if($referIdActivity == 00000000000){
                        ?>
                        	 <button type="button" class="btnStandarKecil" onMouseOver="this.className='btnStandarKecilHover'" onMouseOut="this.className='btnStandarKecil'" id="btnChooseAct" onClick="tampilSelection('chooseAct3', 'ajaxInput1');tampilSelection('chooseAct4', 'ajaxInput2');document.getElementById('statusBtnChooseAct').value='menuAct';" style="width:127px;height:28px;" title="Choose Previous Activity">
                            <table class="fontBtnKecil" onMouseOver="this.className='fontBtnKecilHover'" onMouseOut="this.className='fontBtnKecil'" cellpadding="0" cellspacing="0" width="100%" height="100%" border="0">
                            <tr>
                        ...
                        <?php
							...
							{
						?>
                        <button type="button" class="btnStandarKecil" onMouseOver="this.className='btnStandarKecilHover'" onMouseOut="this.className='btnStandarKecil'" id="btnChooseAct" onClick="tampilSelection('typeAct3', 'ajaxInput1');tampilSelection('typeAct4', 'ajaxInput2');document.getElementById('statusBtnChooseAct').value='teksAct';" style="width:127px;height:28px;" title="Type a New/Edit Activity">
                            <table class="fontBtnKecil" onMouseOver="this.className='fontBtnKecilHover'" onMouseOut="this.className='fontBtnKecil'" cellpadding="0" cellspacing="0" width="100%" height="100%" border="0">
                            <tr>
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <textarea class="elementDefault" id="relatedInfo" name="relatedInfo" style="width:99%;height:56px;"><?php echo $relatedInfo; ?></textarea></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr valign="top">
                    	<td rowspan="6">
...
// JIKA TANGGAL SEKARANG TIDAK SAMA DENGAN TANGGAL YANG TERMASUK ACTIVITY YANG MENERUSKAN ACTIVITY SEBELUMNYA 
                        ...
                        <table cellpadding="0" cellspacing="5" width="100%" border="0" class="formInput" style="cursor:default;">
                            ...
                            <tr valign="top">
                                ...
                                <td><textarea class="elementDefault" id="problemIdent" name="problemIdent" style="width:99%;height:56px;"><?php echo $problemIdent; ?></textarea></td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr valign="top">
                                <td>Corrective Action</td>
                                <td><textarea class="elementDefault" id="corrective" name="corrective" style="width:99%;height:56px;"><?php echo $corrective; ?></textarea></td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr valign="top">
                                <td>KPI Number</td>
                                ...
                                <tr>
                                    <td width="13%">
                                    <input type="text" class="elementDefault" id="kpiNumber" name="kpiNumber" style="width:50px;height:28px;" maxlength="3" value="<?php echo $kpiNumber; ?>">
                                    </td>
                                    <td width="87%"><!-- start === Animated Collapsible DIV contents-->
                                    <a id="hrefKPI" href="javascript:animatedcollapse.toggle('jason')"></a>  
                                        <button type="button" class="btnStandarKecil" onMouseOver="this.className='btnStandarKecilHover'" onMouseOut="this.className='btnStandarKecil'" style="width:90px;height:28px;" title="Open KPI List" onClick="document.getElementById('hrefKPI').click();">
                                            <table class="fontBtnKecil" onMouseOver="this.className='fontBtnKecilHover'" onMouseOut="this.className='fontBtnKecil'" cellpadding="0" cellspacing="0" width="100%" height="100%" border="0">
                                            <tr>
                            ...
                            <tr valign="top">
                                ...
                                <td><textarea class="elementDefault" id="spvComment" name="spvComment" style="width:99%;height:56px;" readonly><?php echo $spvComment; ?></textarea></td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr valign="top">
                                <td>Comment Response</td>
                                <td><textarea class="elementDefault" id="responComment" name="responComment" style="width:99%;height:56px;"><?php echo $responComment; ?></textarea></td>
                                <td align="right">
                                </td>
                            </tr>
                        </table>
...
<tr valign="top">
	...
	<td class="tdMyFolder" colspan="2" bgcolor="#FFFFFF" height="65" valign="middle" style="cursor:default;">&nbsp;
		<button class="btnStandarKecil" onMouseOver="this.className='btnStandarKecilHover'" onMouseOut="this.className='btnStandarKecil'" type="button" style="width:90px;height:55px;" onClick="tutup();" title="Close Edit Activity Window">
        ...
        &nbsp;
        <button class="btnStandarKecil" onMouseOver="this.className='btnStandarKecilHover'" onMouseOut="this.className='btnStandarKecil'" onClick="pilihBtnSave();" style="width:90px;height:55px;" <?php echo $disSave; ?> title="Save Edit Acitivy">
