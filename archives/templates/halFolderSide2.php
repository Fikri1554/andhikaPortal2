...
<body onClick="allHidden();" onLoad="loadScroll('folderSide2');" onUnload="saveScroll('folderSide2');">
...
while($row = $CKoneksi->mysqlFetch($query))
{
	...
	{
		//$pdfYes = "Y";
		//$clickBtnOpen = "parent.parent.openPdf('".$CPublic->konversiSymbol($pathFile)."');";
	}
	...
	$popUpSetting = "<div class=\"elementDefault\" id=\"setFile".$urutan."\" style=\"display:none;width:auto;position:absolute;\">
                ...
                <tr>
                    <td>
                    	<button class=\"btnStandarKecil\" type=\"button\" onclick=\"parent.parent.openThickboxWindow('".$row['ide']."','detailFile');\" style=\"width:110px;height:30px;\" title=\"Detail of this File\">
                ...
                <tr>
                    <td>
                    	<button class=\"btnStandarKecil\" type=\"button\" onclick=\"parent.parent.openThickboxWindow('".$row['ide']."','editFile');\" style=\"width:110px;height:30px;\" title=\"Edit this File\">
                            <table width=\"100%\" height=\"100%\">
                              <tr>
                ...
                <tr>
                    <td>
                    	<button class=\"btnStandarKecil\" type=\"button\" onclick=\"parent.parent.deleteFile('".$row['ide']."');\" style=\"width:110px;height:30px;\" title=\"Delete this File\">
                            <table width=\"100%\" height=\"100%\">
                              <tr>
	...
	$html.= "<div class=\"btnIconFolder\" onMouseOver=\"this.className='btnIconFolderHover'\" onMouseOut=\"this.className='btnIconFolder'\" 
	style=\"width:120px;height:95px;top:145;float:left;margin-left:32px;margin-top:20px;\" onClick=\"allHidden();\" 
	ondblclick=\"".$dobelKlik."\" oncontextmenu=\"showCollapse('".$urutan."');return false;\" title=\"".$title."\">
