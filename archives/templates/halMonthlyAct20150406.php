            ...
            <tr valign="top">
                <td align="center" valign="top" height="130">
                    ...
                    <tr valign="top">
                        ...
                        <td>Activity</td>
                        <td id="ajaxInput1">
                        <input type="text" class="elementDefault" id="activity" name="activity" style="width:99%;height:28px;" value="<?php echo $CPublic->konversiQuotes1($activity); ?>" readonly></td> 
                        <td id="ajaxInput2">&nbsp;</td> 
                    </tr>
                    <tr valign="top">
                   	    <td>Related Information</td>
                        <td>
                            <textarea class="elementDefault" id="relatedInfo" name="relatedInfo" style="width:99%;height:56px;" readonly><?php echo $relatedInfo; ?></textarea></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr valign="top">
                    	<td rowspan="6">
...
// JIKA TANGGAL SEKARANG TIDAK SAMA DENGAN TANGGAL YANG TERMASUK ACTIVITY YANG MENERUSKAN ACTIVITY SEBELUMNYA 
                    ...
                    <tr valign="top">
                        ...
                        <td><textarea class="elementDefault" id="problemIdent" name="problemIdent" style="width:99%;height:56px;" readonly><?php echo $problemIdent; ?></textarea></td>
                    </tr>
                    <tr valign="top">
                    	<td>Corrective Action</td>
                        <td><textarea class="elementDefault" id="corrective" name="corrective" style="width:99%;height:56px;" readonly><?php echo $corrective; ?></textarea></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr valign="top">
                    	<td>KPI Number</td>
                    ...
                    <tr valign="top">
                        ...
                        <td><textarea class="elementDefault" id="responComment" name="responComment" style="width:99%;height:56px;" readonly><?php echo $responComment; ?></textarea></td>
                        <td align="right">
                        </td>
				</tr>
            	</table>
...
<tr valign="top">
	...
	<td class="tdMyFolder" colspan="2" bgcolor="#FFFFFF" height="65" valign="middle" style="cursor:default;">&nbsp;
		<button class="btnStandarKecil" onMouseOver="this.className='btnStandarKecilHover'" onMouseOut="this.className='btnStandarKecil'" type="button" style="width:90px;height:55px;" onClick="exit();" title="Close Edit Activity Window">
