...
{	
	...
	$relatedInfo = $CPublic->potongKarakter($row['relatedinfo'], 65) ;
	$date = $row['tanggal'];
	...
	$html.="<tr onMouseOver=\"this.style.backgroundColor='#DDF0FF';\" onMouseOut=\"this.style.backgroundColor='#FFFFFF';\" onclick=\"parent.openThickboxWindow('".$row['idactivity']."','".$SubOrNo."', '');\">
            <td class=\"tdMyFolder\">
                ...
                <tr style=\"height:23px;\">
					...
					<td align=\"left\" width=\"4%\" style=\"color:#006;font-family:tahoma;font-size:13px;\">".$bosReadJob."</td>
					<td width=\"46%\" align=\"left\" style=\"color:#006;font-family:tahoma;font-size:13px;\">&nbsp;".$relatedInfo."</td>
