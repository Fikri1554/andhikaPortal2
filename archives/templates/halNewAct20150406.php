...
<tr valign="top">
    <td class="tdMyFolder" bgcolor="#FFFFFF" colspan="2" align="center" valign="top" width="100%" style="cursor:default;">
    	<div style="width:890px;height:454px;overflow:scroll;overflow-x: hidden;top: expression(offsetParent.scrollTop);background-color:#FFF;">
                ...
                <td align="center" valign="top" height="130">
                    ...
                    <tr valign="top">
                        ...
                        <td id="ajaxInput1" style="height:28px;">
                        	<input type="text" class="elementDefault" id="activity" name="activity" style="width:99%;height:100%;">
                        </td>
                      	<td id="ajaxInput2">
                        <button type="button" class="btnStandarKecil" onMouseOver="this.className='btnStandarKecilHover'" onMouseOut="this.className='btnStandarKecil'" id="btnChooseAct" onClick="tampilSelection('chooseAct1', 'ajaxInput1');tampilSelection('chooseAct2', 'ajaxInput2');document.getElementById('statusBtnChooseAct').value='menuAct';" style="width:127px;height:28px;" title="Choose Previous Activity">
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <textarea class="elementDefault" id="relatedInfo" name="relatedInfo" style="width:99%;height:56px;"></textarea></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr valign="top">
                    	<td>&nbsp;</td>
                    ...
                    <tr valign="top">
                        ...
                        <tr>
                            <td width="13%">
                                <input type="text" class="elementDefault" id="kpiNumber" name="kpiNumber" style="width:50px;height:28px;" maxlength="3" >
                            </td>
...
<tr valign="top">
	<td class="tdMyFolder" colspan="2" bgcolor="#FFFFFF" height="65" valign="middle" style="cursor:default;">&nbsp;
		<button class="btnStandarKecil" onMouseOver="this.className='btnStandarKecilHover'" onMouseOut="this.className='btnStandarKecil'" type="button" style="width:90px;height:55px;" onClick="tutup();" title="Close Create New Activity Window">
        ...
        &nbsp;
        <button class="btnStandarKecil" onMouseOver="this.className='btnStandarKecilHover'" onMouseOut="this.className='btnStandarKecil'" onClick="pilihBtnSave();" style="width:90px;height:55px;" title="Save New Acitivy">
        ...
        &nbsp;
        <button class="btnStandarKecil" onMouseOver="this.className='btnStandarKecilHover'" onMouseOut="this.className='btnStandarKecil'" onClick="pilihBtnLeave();" style="width:95px;height:55px;" title="Leave (Cuti) Status on Calendar Activity">
            <table class="fontBtnKecil" onMouseOver="this.className='fontBtnKecilHover'" onMouseOut="this.className='fontBtnKecil'" border="0" width="100%" height="100%">
            <tr>
        ...
        &nbsp;
        <button class="btnStandarKecil" onMouseOver="this.className='btnStandarKecilHover'" onMouseOut="this.className='btnStandarKecil'" onClick="pilihBtnSick();" style="width:90px;height:55px;" title="Sick Status on Calendar Activity">
            <table class="fontBtnKecil" onMouseOver="this.className='fontBtnKecilHover'" onMouseOut="this.className='fontBtnKecil'" border="0" width="100%" height="100%">
            <tr>
