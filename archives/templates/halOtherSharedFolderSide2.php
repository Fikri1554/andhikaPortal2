...
<body onClick="allHidden();" onLoad="loadScroll('otherShareFolderSide2');" onUnload="saveScroll('otherShareFolderSide2');"> 
...
$html = "";
$urutan = 0;
$query=$CKoneksi->mysqlQuery("SELECT * FROM mstdoc WHERE idfold='".$idFoldGet."'AND deletests=0 ORDER BY namedoc ASC");
while($row = $CKoneksi->mysqlFetch($query))
{
	...
	$popUpSetting = "<div class=\"elementDefault\" id=\"setFile".$urutan."\" style=\"display:none;width:auto;position:absolute;\">
                ...
                <tr>
                    <td>
                    	<button class=\"btnStandarKecil\" type=\"button\" onclick=\"parent.parent.openThickboxWindow('".$row['ide']."','detailOtherShareFile');\" style=\"width:110px;height:30px;\" title=\"Detail of this File\">
	...
	style=\"width:120px;height:95px;top:145px;float:left;margin-left:32px;margin-top:20px;\" onClick=\"allHidden();\" 
...
function btnEdit($ide)
{
	...
	//for icon html
	$html.= "<tr><td>
			<button class=\"btnStandarKecil\" type=\"button\" onclick=\"parent.parent.openThickboxWindow('".$ide."','editOtherShareFile');\" style=\"width:110px;height:30px;\" title=\"Edit this File\">
					<table width=\"100%\" height=\"100%\">
					  <tr>
