...
<body onClick="allHidden();" onLoad="loadScroll('ownSharedFolderSide2');" onUnload="saveScroll('ownSharedFolderSide2');"> 
...
if($idFoldGet != "")
{
	...
	while($row = $CKoneksi->mysqlFetch($query))
	{
		...
		$onClickDetail = "parent.parent.openThickboxWindow('".$row['ide']."','detailOwnShareFile');";
		...
		$popUpSetting = "<div class=\"elementDefault\" id=\"setFile".$urutan."\" style=\"display:none;width:auto;position:absolute;\">
					...
					<tr>
						<td>
							<button class=\"btnStandarKecil\" type=\"button\" onclick=\"".$onClickDetail."\" style=\"width:110px;height:30px;\" title=\"Detail of this File\">
					...
					<tr>
						<td>
							<button class=\"btnStandarKecil\" type=\"button\" onclick=\"".$onClickOpen."\" style=\"width:110px;height:30px;\" title=\"Open/Save this File to LocalDisk\">
								<table width=\"100%\" height=\"100%\">
								  <tr>
		...
		$html.= "<div class=\"btnIconFolder\" onMouseOver=\"this.className='btnIconFolderHover'\" onMouseOut=\"this.className='btnIconFolder'\" style=\"width:120px;height:95px;top:145;float:left;margin-left:32px;margin-top:20px;\" onClick=\"allHidden();\" ondblclick=\"".$clickBtnOpen."\" oncontextmenu=\"showCollapse('".$urutan."');return false;\" title=\"".$title."\">
