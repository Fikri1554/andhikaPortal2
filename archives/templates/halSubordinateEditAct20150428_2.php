            ...
            <tr>
                <td align="center" valign="top" height="130">
                    ...
                    <tr valign="top">
                        ...
                        <td align="left"><input type="text" class="elementDefault" id="activity" name="activity" style="width:430px;" value="<?php echo $CPublic->konversiQuotes1($activity); ?>" readonly></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr valign="top">
