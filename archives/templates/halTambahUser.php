...
if($halamanPost == "simpanNewUser")
{
	...
	$CKoneksi->mysqlQuery("INSERT INTO login (empno, username, userpass, userfullnm, userinit, active, nmdiv, nmdept, nmjabatan, addusrdt)VALUES ('".$empNo."', '".$username."', md5('".$password."'), '".$userfullnm."', '".$userInit."', '".$active."', '".$nmDiv."', '".$nmDept."', '".$nmJab."', '".$CPublic->userWhoAct()."');");
	$lastUserId = mysql_insert_id();
	$CHistory->updateLog($userIdLogin, "Buat User baru (userId = '".$CPublic->zerofill($lastUserId, 5)."', Username = <b>".$username."</b>, Fullname = <b>".$userfullnm."</b>)");
...
if($halamanPost == "simpanEditUser")
{
	...
	if($password == "")
	{
		$CKoneksi->mysqlQuery("UPDATE login SET username = '".$username."', active = '".$active."', kddiv = '".$divisi."', nmdiv='".$nmDiv."', nmdept='".$nmDept ."', nmjabatan='".$nmJab."', updusrdt = '".$CPublic->userWhoAct()."' WHERE userid = '".$userId."' AND deletests=0");
		$CHistory->updateLog($userIdLogin, "Rubah user (Nama = <b>".$CLogin->detilLogin($userId, "userfullnm")."</b>, Username = <b>".$username."</b>, active = <b>".$active."</b>, kddiv = <b>".$divisi."</b>)");
	}
	elseif($password != "")
	{
		$CKoneksi->mysqlQuery("UPDATE login SET username = '".$username."', userpass = md5('".$password."'), active = '".$active."', kddiv = '".$divisi."', nmdiv='".$nmDiv."', nmdept='".$nmDept ."', nmjabatan='".$nmJab."', updusrdt = '".$CPublic->userWhoAct()."' WHERE userid = '".$userId."' AND deletests=0");
		$CHistory->updateLog($userIdLogin, "Rubah user (Nama = <b>".$CLogin->detilLogin($userId, "userfullnm")."</b>, Username = <b>".$username."</b>, Password = <b>#####</b>, active = <b>".$active."</b>, kddiv = <b>".$divisi."</b>)");
	}
}
?>
...
function ajaxGetGiveAccess(statusCentang, aksi)
{
	...
	if(aksi == "cekMenuSetting"  || aksi == "cekMenuApplication" || aksi == "cekBtnUser" || aksi == "cekLogHistory" || aksi == "cekCustomSub" || aksi == "cekOtherApp" || aksi == "cekKpiSetting")
	{ 
        ...
        <tr>
            ...
            <form action="halTambahUser.php" method="post" enctype="multipart/form-data" id="formUser" name="formUser">
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input type="text" class="elementSearch" id="username" name="username" style="width:99%;height:28px;" value="<?php echo $username; ?>">
                    </td>
                </tr>
                <tr valign="top">
                    <td height="28">Password</td>
                    <td>
                        <input type="password" class="elementSearch" id="password" name="password" style="width:99%;height:28px;" value="<?php echo $password; ?>">
                    </td>
                </tr>
                <tr valign="top">
            ...
            <td rowspan="4" valign="top">
                ...
                <tr>
                    <td class="tabelBorderTopNull" style="border-width:thin;">
                        ...
                        <tr>
                            <td>&nbsp;<input <?php echo $disGiveAccess; ?> <?php echo $cekMenuSetting; ?> type="checkbox" onClick="ajaxGetGiveAccess(this.checked, 'cekMenuSetting');" >&nbsp;Menu Setting</td>
                        </tr>
                        <tr>
                        	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input <?php echo $disGiveAccess; ?> <?php echo $cekBtnUser; ?> onClick="ajaxGetGiveAccess(this.checked, 'cekBtnUser');" type="checkbox" >&nbsp;Button User</td>
                        </tr>
                        <tr>
                        	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input <?php echo $disGiveAccess; ?> <?php echo $cekBtnLogHistory; ?> onClick="ajaxGetGiveAccess(this.checked, 'cekLogHistory');" type="checkbox" >&nbsp;Button Log History</td>
                        </tr>
                        <tr>
                        	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input <?php echo $disGiveAccess; ?> <?php echo $cekBtnCustomSub; ?> onClick="ajaxGetGiveAccess(this.checked, 'cekCustomSub');" type="checkbox" >&nbsp;Button Custom Sub</td>
                        </tr>
                        <tr>
                        	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input <?php echo $disGiveAccess; ?> <?php echo $cekBtnOtherApp; ?> onClick="ajaxGetGiveAccess(this.checked, 'cekOtherApp');" type="checkbox" >&nbsp;Button Other App</td>
                        </tr>
                        <tr>
                        	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input <?php echo $disKpiSetting; ?> <?php echo $cekBtnKpiSetting; ?> onClick="ajaxGetGiveAccess(this.checked, 'cekKpiSetting');" type="checkbox" >&nbsp;Button KPI Setting</td>
                        </tr>
                        <tr>
                            <td>&nbsp;<input <?php echo $disGiveAccess; ?> <?php echo $cekMenuApplication; ?> type="checkbox" onClick="ajaxGetGiveAccess(this.checked, 'cekMenuApplication');" >&nbsp;Menu Application</td>
                        </tr>
                        </table>
...
<tr valign="top">
	<td colspan="2" class="tdMyFolder" bgcolor="#FFFFFF" height="65" valign="middle">
        &nbsp;
        <button onClick="exit();" class="btnStandarKecil" onMouseOver="this.className='btnStandarKecilHover'" onMouseOut="this.className='btnStandarKecil'" style="width:90px;height:55px;" title="Close User Window">
        ...
        &nbsp;
        <button onClick="pilihBtnSave();" class="btnStandarKecil" onMouseOver="this.className='btnStandarKecilHover'" onMouseOut="this.className='btnStandarKecil'" style="width:90px;height:55px;" title="Save New User">
            <table width="100%" height="100%" class="fontBtnKecil" onMouseOver="this.className='fontBtnKecilHover'" onMouseOut="this.className='fontBtnKecil'">
            <tr>
