...
if($aksiPost == "klikPayMethod")
{
	...
	$html = "";
	$html.= "<select id=\"bankCode\" name=\"bankCode\" class=\"elementMenu\" style=\"width:300px;\" onchange=\"klikBankMenu(bankCode);return false;\">";
...
{	
	...
	if($amtConvPost != "")
	{
		...
		{
			$nilai = round(($amtConv - $totalAmountPost), 2);
		}
	}
