...
if($userIdSession != "")
{
	...
	if($userJenisInvReg != "")
	{
		...
		if($halamanPost == "halPaymentAddList")
		{
			$tpl->AssignInclude("CONTENT_TENGAH","templates/halPaymentAdd.php");
		}
		if($halamanPost == "halVerify")
		{
			$tpl->AssignInclude("CONTENT_TENGAH","templates/halVerify.php");
		}
		if($halamanPost == "halPaymentList")
		{
			$tpl->AssignInclude("CONTENT_TENGAH","templates/halPaymentAddList.php");
		}
...
if($userJenisInvReg == "user")
{
	...
	$tpl->Assign("disBtnUnlockPage", $CInvReg->aksesBtn($userIdSession, "", "btninvprocess_unlockpage", "btnUnlockPage"));
	...
	//OUTGOING
	$tpl->Assign("disBtnOutgoing_New", $CInvReg->aksesBtn($userIdSession, "", "btnoutgoing_new", "btnOutgoingNew"));
	$tpl->Assign("disBtnOutgoing_Edit", $CInvReg->aksesBtn($userIdSession, "", "btnoutgoing_edit", "btnOutgoingEdit"));
	$tpl->Assign("disBtnOutgoing_Delete", $CInvReg->aksesBtn($userIdSession, "", "btnoutgoing_delete", "btnOutgoingDelete"));
...
if($halamanPost == "halPrintMailInv")
{
	...
	$tpl->Assign("slcUnitDiv",$CInvReg->menuUnit(''));
}
