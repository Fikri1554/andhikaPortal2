...
function klikBtnCari()
{
	...
	parent.disabledBtn('btnCariPrintResult');
	...
	if($.trim( teksCari ) == '' && (startDate == '' && endDate == ''))
	{
		pesanError("Please fill the empty field", "teksCari");
		return false;
	}
...
*/	
	...
	$('#formPrintResult').attr('action', 'halPrint.php?aksi=printResult&cariBerdasarkan='+cariBerdasarkan+'&teksCari='+teksCari+'&startDate='+startDate+'&endDate='+endDate+'&allIdMailInv='+allIdMailInv);
