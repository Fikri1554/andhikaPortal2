...
// Jika urutan grup = 1, maka tampilkan nama vendor
	...
	?>
<!-- Nama Vendor -->
    	<tr><td class="tabelBorderBottomJust" colspan="13" height="28" style="font:1em Arial Narrow;font-weight:bold;">&nbsp;<?php echo $row['kreditacc']." - ".$row['vendor']." - ".$row['currency']; ?></td></tr>
	<?php } ?>  
     
<!-- LIST -->
        <tr style="font:0.8em Arial Narrow;font-weight:normal;">
            <td height="22" width="30" style="<?php echo $bgClr;?>" class="tabelBorderRightJust" align="center"><?php echo $row['urutangrup']; ?></td>
            <td width="200" style=" <?php echo $bgClr;?>padding-left:3px;" class="tabelBorderRightJust"><div style="width:120px; word-wrap:break-word;"><?php echo $row['mailinvno']; ?>&nbsp;</div></td>
            <td width="120" style=" <?php echo $bgClr;?>" class="tabelBorderRightJust" align="center"><?php echo $row['barcode']; ?></td>
            <td width="150" style=" <?php echo $bgClr;?>" class="tabelBorderRightJust" align="center"><?php echo $CPublic->convTglNonDB($row['receivedate']); ?></td>
            <td width="150" style=" <?php echo $bgClr;?>" class="tabelBorderRightJust" align="center"><?php echo $CPublic->convTglNonDB($row['tglinvoice']); ?></td>
            <td width="100" style=" <?php echo $bgClr;?>" class="tabelBorderRightJust" align="center"><?php echo $row['dueday']; ?></td>
            <td width="150" style=" <?php echo $bgClr;?>" class="tabelBorderRightJust" align="center"><?php echo $CPublic->convTglNonDB($row['tglexp']); ?>&nbsp;</td>
            <td width="100" style=" <?php echo $bgClr;?>" class="tabelBorderRightJust" align="right"><?php echo $current; ?>&nbsp;</td>
            <td width="100" style=" <?php echo $bgClr;?>" class="tabelBorderRightJust" align="right"><?php echo $rangeSatu; ?>&nbsp;</td>
            <td width="100" style=" <?php echo $bgClr;?>" class="tabelBorderRightJust" align="right"><?php echo $rangeDua; ?>&nbsp;</td>
            <td width="100" style=" <?php echo $bgClr;?>" class="tabelBorderRightJust" align="right"><?php echo $rangeTiga; ?>&nbsp;</td>
            <td width="100" style=" <?php echo $bgClr;?>" class="tabelBorderRightJust" align="right"><?php echo $rangeEmpat; ?>&nbsp;</td>
            <td width="100" style=" <?php echo $bgClr;?>" align="right"><?php echo $rangeLima; ?>&nbsp;</td>
        </tr>
...
<!-- Sub Total -->
        <tr style="font:0.9em Arial Narrow;font-weight:bold;" height="20">
            ...
            <!-- <td class="tabelBorderLeftNull" align="right"><?php echo number_format($CAging->hitungSubTotal($userId, $row['kreditacc'], $row['currency'], ""), 2, ",", "."); ?>&nbsp;</td> -->
            <td class="tabelBorderLeftNull" align="right"></td>
    ...
    <!-- Total IDR & USD -->
    	<tr style="font:0.8em Arial Narrow;font-weight:bold;background-color:#F5F5DC;">
            ...
            <td class="tabelBorderRightJust" style="font:1.1em Arial Narrow;font-weight:bold;">&nbsp;Total - IDR</td>
            <td class="tabelBorderRightJust" align="right"></td>
            ...
            <td align="right"><?php echo $totalRangeLimaIdr; ?>&nbsp;</td>
        </tr>
        
        <tr style="font:0.8em Arial Narrow;font-weight:bold;background-color:#F5F5DC;">
            <td colspan="6" class="tabelBorderLeftRightNull">&nbsp;</td>
            <td class="tabelBorderLeftNull" style="font:1.1em Arial Narrow;font-weight:bold;">&nbsp;Total - USD</td>
            <td class="tabelBorderLeftNull" align="right"></td>
        ...
        ?>
            <tr style="font:0.8em Arial Narrow;font-weight:bold;background-color:#F5F5DC;">
                <td colspan="6" height="24">&nbsp;</td>
                <td class="tabelBorderRightJust" style="font:1.1em Arial Narrow;font-weight:bold;">&nbsp;Total - <?php echo $currOther1;?></td>
                <td class="tabelBorderRightJust" align="right"></td>
                ...
                <td align="right"><?php echo $totalOther1RangeLima; ?>&nbsp;</td>
            </tr>
        <?php
            }
            if($currOther2 != ""){
        ?>
            <tr style="font:0.8em Arial Narrow;font-weight:bold;background-color:#F5F5DC;">
                <td colspan="6" height="24">&nbsp;</td>
                <td class="tabelBorderRightJust" style="font:1.1em Arial Narrow;font-weight:bold;">&nbsp;Total - <?php echo $currOther2;?></td>
                <td class="tabelBorderRightJust" align="right"></td>
                ...
                <td align="right"><?php echo $totalOther2RangeLima; ?>&nbsp;</td>
            </tr>
        <?php } ?>
	</table>
    </td>
