...
<body>
    <table id="judul1" cellpadding="0" cellspacing="0" width="760" border="0"
        ...
        <tr align="center">
            ...
            <td width="70" class="" style="font-size:10px;">SUB<br>ACCOUNT</td>
            <td width="" class="">SENDER / VENDOR NAME</td>
        </tr>
    </table>

    <div style="position:absolute;top:30px;overflow:hidden;">
        <table cellpadding="0" cellspacing="0" width="760" style="font:0.7em sans-serif;color:#333;">
            <?php
$i=0;
$totalAmount = 0;
$amount = 0;
...
$query = $CKoneksiInvReg->mysqlQuery("SELECT sendervendor1, tipesenven, sendervendor2, sendervendor2name, companyname, currency, addi, deduc, amount, kreditacc, kreditaccname, subcode FROM mailinvoice WHERE transno=".$transNoGet." AND deletests=0 ORDER BY urutan ASC;", $CKoneksiInvReg->bukaKoneksi());
...
?>
            <tr align="center">
                ...
                <td width="130" class="tabelBorderRightJust">
                    <?php echo number_format((float)$totalAmount, 2, '.', ','); ?></td>
                <td width="70" class="tabelBorderRightJust"><?php echo $row['kreditacc']; ?></td>
                <td width="70" class="tabelBorderRightJust"><?php echo $row['subcode']; ?><input type="hidden"
                        value="<?php echo $row['subcode']; ?>" id="txtSubAccountHid"></td>
                <td width="" class="tabelBorderAllNull"><?php echo $senderVendor; ?></td>
            </tr>
            <?php
        echo "";
    }
