...
function onClickTrBatch(trId, idMailInv, transNo, bgColor)
{
	...
	$('#paidToFrom', parent.document).attr("disabled","disabled");
	$('#paidToFrom', parent.document).css("background-color","E9E9E9");
	...
	$('#paidToFrom', parent.document).val( '' );
...
{
?>
	//alert('<?php echo $pageTransno." / ".$totalTransno; ?>');
