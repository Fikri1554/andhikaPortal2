...
<tr>
    ...
    <td valign="top">
        ...
        <tr>
            ...
            <td class="elementTeks">
                <input type="text" name="deducRet" id="deducRet" class="elementInput" style="width:100px;text-align:right;"/>
            </td>
        </tr>
        <tr>
            <td height="22" class="">&nbsp;&nbsp;&nbsp;&nbsp;Additional</td>
            <td class="elementTeks">
            	<input type="text" name="addiRet" id="addiRet" class="elementInput" style="width:100px;text-align:right;"/>
            </td>
        </tr>
        <tr valign="top">
