...
if($aksiPost  == "simpanEditInvRet")
{
	...
	$totalDeducPost = $_POST['totalDeduc'];
	$totalAddiPost = $_POST['totalAddi'];
...
//$echo.= "<tr><td>------------------------------------------------------------------------------------------------------------------------------------</td></tr>";
				...
				$koneksiOdbcAcc->odbcExec($koneksiOdbcAccId, "INSERT INTO ".$dbAccounting." 
						...
						('".$compcode."', '".$sourcePost."', '".$bookDate."', '".$voucherPost."', '".$refNumber."', '".substr($invNo, 0, 16)."', '".$poNo."', '".substr($CPublic->ms_escape_string( $_POST['description'] ), 0, 70)."', '".$vslCodePost."', '".$debitAccPost."', '', '".$subCodePost."', '".$invCurr."', 'DB', '".number_format((float)$debitAmt, 2, '.', '')."', '".$invCurr."', '^', '".$entryDateMSSQL."', '".$userName."', 'Transfer JE:".$batchnoGet."')");
						
				$CHistory->updateLogInvReg($userIdLogin, "Simpan Invoice Returned (DEBIT) (INSERT INTO ".$dbAccounting." (Company = <b>".$compcode."</b>, Source = <b>".$sourcePost."</b>, Bookdate = <b>".$bookDate."</b>, Voucher = <b>".$voucherPost."</b>, Refnumber = <b>".$refNumber."</b>, Invoiceno = <b>".substr($invNo, 0, 16)."</b>, Pono = <b>".$poNo."</b>, Bookdesc = <b>".substr($CPublic->ms_escape_string( $_POST['description'] ), 0, 70)."</b>, Vessel = <b>".$vslCodePost."</b>, Account = <b>".$debitAccPost."</b>, Subacct =, Subcode = <b>".$subCodePost."</b>, Currcy = <b>".$invCurr."</b>, Booksts = <b>DB</b>, Amount = <b>".number_format((float)$debitAmt, 2, '.', '')."</b>, Diffcur = <b>".$invCurr."</b>, Codests = <b>'^'</b>, Entrydate = <b>".$entryDateMSSQL."</b>, Entryuser = <b>".$userName."</b>, Progdebug = <b>Transfer JE:".$batchnoGet."</b>)");
				...
				for($i=1;$i<=5;$i++)
				{
					...
					if($addiAcc != "")
					{
						$koneksiOdbcAcc->odbcExec($koneksiOdbcAccId, "INSERT INTO ".$dbAccounting." 
						(Company, Source, Bookdate, Voucher, Refnumber, Invoiceno, Pono, Bookdesc, Vessel, Account, Subacct, Subcode, Currcy, Booksts, Amount, Diffcur, Codests, Entrydate, Entryuser, Progdebug) VALUES 
						('".$compcode."', '".$sourcePost."', '".$bookDate."', '".$voucherPost."', '".$refNumber."', '".substr($invNo, 0, 16)."', '".$poNo."', '".substr($CPublic->ms_escape_string( $addiReason ), 0, 70)."', '".$vslCodePost."', '".$addiAcc."', '', '".$subCodePost."', '".$invCurr."', 'DB', '".number_format((float)$addiAmount, 2, '.', '')."', '".$invCurr."', '^', '".$entryDateMSSQL."', '".$userName."', 'Transfer JE:".$batchnoGet."')");
						
						$CKoneksiInvReg->mysqlQuery("INSERT INTO tblsplit (idmailinv, userid, fieldaksi, urutan, pay, booksts, account, amount, description, addusrdt) VALUES ('".$idMailInvGet."', '".$userIdLogin."', 'additional', '".$i."', '".$addiCekPay."', 'DB', '".$addiAcc."', '".number_format((float)$addiAmount, 2, '.', '')."', '".$addiReason."', '".$userWhoActNew."')", $CKoneksiInvReg->bukaKoneksi());
						
						$CHistory->updateLogInvReg($userIdLogin, "Simpan Invoice Returned (DEBIT) (INSERT INTO ".$dbAccounting." (Company = <b>".$compcode."</b>, Source = <b>".$sourcePost."</b>, Bookdate = <b>".$bookDate."</b>, Voucher = <b>".$voucherPost."</b>, Refnumber = <b>".$refNumber."</b>, Invoiceno = <b>".substr($invNo, 0, 16)."</b>, Pono = <b>".$poNo."</b>, Bookdesc = <b>".substr($CPublic->ms_escape_string( $addiReason ), 0, 70)."</b>, Vessel = <b>".$vslCodePost."</b>, Account = <b>".$addiAcc."</b>, Subacct =, Subcode = <b>".$subCodePost."</b>, Currcy = <b>".$invCurr."</b>, Booksts = <b>'DB'</b>, Amount = <b>".number_format((float)$addiAmount, 2, '.', '')."</b>, Diffcur = <b>".$invCurr."</b>, Codests = <b>'^'</b>, Entrydate = <b>".$entryDateMSSQL."</b>, Entryuser = <b>".$userName."</b>, Progdebug = <b>Transfer JE:".$batchnoGet."</b>)");
						$CHistory->updateLogInvReg($userIdLogin, "Simpan Invoice Returned  (DEBIT) (INSERT INTO tblsplit (idmailinv = <b>".$idMailInvGet."</b>, userid = <b>".$userIdLogin."</b>, fieldaksi = <b>additional</b>, urutan = <b>".$i."</b>, pay = <b>".$addiCekPay."</b>, booksts = <b>DB</b>, account = <b>".$addiAcc."</b>, amount = <b>".number_format((float)$addiAmount, 2, '.', '')."</b>, description = <b>".$addiReason."</b>, addusrdt = <b>".$userWhoActNew."</b>)");
					}
				}
//$echo.= "<tr><td>------------------------------------------------------------------------------------------------------------------------------------</td></tr>";
				// ############ ROW CREDIT
				...
				$koneksiOdbcAcc->odbcExec($koneksiOdbcAccId, "INSERT INTO ".$dbAccounting." 
						(Company, Source, Bookdate, Voucher, Refnumber, Invoiceno, Pono, Bookdesc, Vessel, Account, Subacct, Subcode, Currcy, Booksts, Amount, Diffcur, Codests, Entrydate, Entryuser, Progdebug) VALUES 
						('".$compcode."', '".$sourcePost."', '".$bookDate."', '".$voucherPost."', '".$refNumber."', '".substr($invNo, 0, 16)."', '".$poNo."', '".substr($CPublic->ms_escape_string( $_POST['description'] ), 0, 70)."', '".$vslCodePost."', '".$kreditAccPost."', '', '".$subCodePost."', '".$invCurr."', 'CR', '".number_format((float)$creditAmt, 2, '.', '')."', '".$invCurr."', '^', '".$entryDateMSSQL."', '".$userName."', 'Transfer JE:".$batchnoGet."')");
				...
				for($i=1;$i<=5;$i++)
				{
					...
					if($deducAcc != "")
					{
						$koneksiOdbcAcc->odbcExec($koneksiOdbcAccId, "INSERT INTO ".$dbAccounting." 
						(Company, Source, Bookdate, Voucher, Refnumber, Invoiceno, Pono, Bookdesc, Vessel, Account, Subacct, Subcode, Currcy, Booksts, Amount, Diffcur, Codests, Entrydate, Entryuser, Progdebug) VALUES 
						('".$compcode."', '".$sourcePost."', '".$bookDate."', '".$voucherPost."', '".$refNumber."', '".substr($invNo, 0, 16)."', '".$poNo."', '".substr($CPublic->ms_escape_string( $deducReason ), 0, 70)."', '".$vslCodePost."', '".$deducAcc."', '', '".$subCodePost."', '".$invCurr."', 'CR', '".number_format((float)$deducAmount, 2, '.', '')."', '".$invCurr."', '^', '".$entryDateMSSQL."', '".$userName."', 'Transfer JE:".$batchnoGet."')");
						
						$CKoneksiInvReg->mysqlQuery("INSERT INTO tblsplit (idmailinv, userid, fieldaksi, urutan, booksts, account, amount, description, addusrdt) VALUES ('".$idMailInvGet."', '".$userIdLogin."', 'deduction', '".$i."', 'CR', '".$deducAcc."', '".number_format((float)$deducAmount, 2, '.', '')."', '".$deducReason."', '".$userWhoActNew."')", $CKoneksiInvReg->bukaKoneksi());
						
						$CHistory->updateLogInvReg($userIdLogin, "Simpan Invoice Returned (CREDIT) (INSERT INTO ".$dbAccounting." (Company = <b>".$compcode."</b>, Source = <b>".$sourcePost."</b>, Bookdate = <b>".$bookDate."</b>, Voucher = <b>".$voucherPost."</b>, Refnumber = <b>".$refNumber."</b>, Invoiceno = <b>".substr($invNo, 0, 16)."</b>, Pono = <b>".$poNo."</b>, Bookdesc = <b>".substr($CPublic->ms_escape_string( $deducReason ), 0, 70)."</b>, Vessel = <b>".$vslCodePost."</b>, Account = <b>".$deducAcc."</b>, Subacct =, Subcode = <b>".$subCodePost."</b>, Currcy = <b>".$invCurr."</b>, Booksts = <b>CR</b>, Amount = <b>".number_format((float)$deducAmount, 2, '.', '')."</b>, Diffcur = <b>".$invCurr."</b>, Codests = <b>'^'</b>, Entrydate = <b>".$entryDateMSSQL."</b>, Entryuser = <b>".$userName."</b>, Progdebug = <b>Transfer JE:".$batchnoGet."</b>)");
						$CHistory->updateLogInvReg($userIdLogin, "Simpan Invoice Returned  (CREDIT) (INSERT INTO tblsplit (idmailinv = <b>".$idMailInvGet."</b>, userid = <b>".$userIdLogin."</b>, fieldaksi = <b>deduction</b>, urutan = <b>".$i."</b>, booksts = <b>CR</b>, account = <b>".$deducAcc."</b>, amount = <b>".number_format((float)$deducAmount, 2, '.', '')."</b>, description = <b>".$deducReason."</b>, addusrdt = <b>".$userWhoActNew."</b>)");
					}
				}
			}
...
//$echo.= "<tr><td>------------------------------------------------------------------------------------------------------------------------------------</td></tr>";
				...
				while($rowSplit = $CKoneksiInvReg->mysqlFetch($querySplit))
				{
					$koneksiOdbcAcc->odbcExec($koneksiOdbcAccId, "INSERT INTO ".$dbAccounting." 
					(Company, Source, Bookdate, Voucher, Refnumber, Invoiceno, Pono, Bookdesc, Vessel, Account, Subacct, Subcode, Currcy, Booksts, Amount, Diffcur, Codests, Entrydate, Entryuser, Progdebug) VALUES 
					('".$compcode."', '".$sourcePost."', '".$bookDate."', '".$voucherPost."', '".$refNumber."', '".substr($invNo, 0, 16)."', '".$poNo."', '".substr($CPublic->ms_escape_string( $rowSplit['description'] ), 0, 70)."', '".$vslCodePost."', '".$rowSplit['account']."', '', '".$subCodePost."', '".$invCurr."', 'DB', '".number_format((float)$rowSplit['amount'], 2, '.', '')."', '".$invCurr."', '^', '".$entryDateMSSQL."', '".$userName."', 'Transfer JE:".$batchnoGet."')");
					
					$CKoneksiInvReg->mysqlQuery("INSERT INTO tblsplit (idmailinv, userid, fieldaksi, urutan, pay, booksts, account, amount, description, addusrdt) VALUES ('".$idMailInvGet."', '".$userIdLogin."', 'memodebit', '".$rowSplit['urutan']."', '".$rowSplit['pay']."', 'DB', '".$rowSplit['account']."', '".number_format((float)$rowSplit['amount'], 2, '.', '')."', '".substr($CPublic->ms_escape_string( $rowSplit['description'] ), 0, 70)."', '".$userWhoActNew."')", $CKoneksiInvReg->bukaKoneksi());
					
					$CHistory->updateLogInvReg($userIdLogin, "Simpan Invoice Returned (DEBIT) (INSERT INTO ".$dbAccounting." (Company = <b>".$compcode."</b>, Source = <b>".$sourcePost."</b>, Bookdate = <b>".$bookDate."</b>, Voucher = <b>".$voucherPost."</b>, Refnumber = <b>".$refNumber."</b>, Invoiceno = <b>".substr($invNo, 0, 16)."</b>, Pono = <b>".$poNo."</b>, Bookdesc = <b>".substr($CPublic->ms_escape_string( $rowSplit['description'] ), 0, 70)."</b>, Vessel = <b>".$vslCodePost."</b>, Account = <b>".$rowSplit['account']."</b>, Subacct =, Subcode = <b>".$subCodePost."</b>, Currcy = <b>".$invCurr."</b>, Booksts = <b>DB</b>, Amount = <b>".number_format((float)$rowSplit['amount'], 2, '.', '')."</b>, Diffcur = <b>".$invCurr."</b>, Codests = <b>'^'</b>, Entrydate = <b>".$entryDateMSSQL."</b>, Entryuser = <b>".$userName."</b>, Progdebug = <b>Transfer JE:".$batchnoGet."</b>)");
					$CHistory->updateLogInvReg($userIdLogin, "Simpan Invoice Returned  (DEBIT) (INSERT INTO tblsplit (idmailinv = <b>".$idMailInvGet."</b>, userid = <b>".$userIdLogin."</b>, fieldaksi = <b>memodebit</b>, urutan = <b>".$rowSplit['urutan']."</b>, pay = <b>".$rowSplit['pay']."</b>, booksts = <b>DB</b>, account = <b>".$rowSplit['account']."</b>, amount = <b>".number_format((float)$rowSplit['amount'], 2, '.', '')."</b>, description = <b>".substr($CPublic->ms_escape_string( $rowSplit['description'] ), 0, 70)."</b>, addusrdt = <b>".$userWhoActNew."</b>)");
				}
...
?>
<div style="position:absolute;top:9px;left:15px;border:solid 1px #666;background-color:#FFF;z-index:4;<?php echo $display; ?>">
...
<tr>
    ...
    <span style="font-size:15px;font-family:sans-serif;font-weight:bold;color:#485a88;text-decoration:underline;">TRANSFER JURNAL ENTRY</span> <span id="tess"></span>
    </td>
</tr>
...
<tr>
    <td width="50%" valign="top">
        ...
        <tr>
            ...
            <td class="">
                <input type="text" name="dateReturned" id="dateReturned" class="elementInput3" style="width:65px;" value="<?php echo $dateReturned; ?>"/>
        ...
        <tr>
            ...
            <td class=""><input type="checkbox" id="ignoredJe" name="ignoredJe" style="cursor:pointer;" <?php echo $checkIgnoreJE; ?>>&nbsp;<span id="ignoredJeNo" style="position:relative;bottom:3px;" class="elementTeks">NO</span></td>
        </tr>
        <tr>
            <td height="22" class="">Approve Payment</td>
            <td class=""><input type="checkbox" id="approvePayment" name="approvePayment" style="cursor:pointer;" <?php echo $checkApprPayment; ?>>&nbsp;<span id="approvePaymentNo" style="position:relative;bottom:3px;" class="elementTeks">YES</span></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="">
                <input type="text" name="source" id="source" class="elementInput3" style="width:60px;" maxlength="3" value="<?php echo $source; ?>"/>
            </td>
        </tr>
        <tr>
            <td height="22">Debit Account</td>
            <td valign="middle">
                <input type="text" name="debitAcc" id="debitAcc" class="elementInput3" style="width:60px;" value="<?php echo $debitAcc; ?>" maxlength="5"/>
                <span id="spanDebitAccName" class="elementTeks" style="font-family:'Arial Narrow';"><?php echo $debitAccName; ?>&nbsp;</span>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <input type="checkbox" id="splitDebAcc" name="splitDebAcc" style="cursor:pointer;" <?PHP echo $checkDebSplit; ?>>
            <span id="splitDebAccNo" style="position:relative;bottom:3px;" class="elementTeks">NO</span>
            	<button type="button" class="<?php echo $classBtnViewSplitDeb; ?>" id="btnViewSplitDeb" title="SPLIT DEBIT ACCOUNT" style="position:absolute;left:180px;width:62px;height:20px;" onclick="klikBtnViewDeb();" <?php echo $disBtnViewSplitDeb; ?>>
        ...
        <tr>
            ...
            <td class="">
                <input type="text" name="subCode" id="subCode" class="elementInput3" style="width:60px;" maxlength="5" value="<?php echo $subCode; ?>"/>
            </td>
        </tr>
        <tr valign="top">
            <td height="44" class="">Description</td>
            <td class="">
                <textarea id="description" name="description" class="elementInput" cols="45" style="height:37px;" onkeyup="textCounter(this, sisaDesc, 70);"><?php echo $description; ?></textarea>
        ...
        <tr>
            ...
            <td class="elementTeks">
                <span id="senderVendorCode2"><input type="text" name="kreditAcc" id="kreditAcc" class="elementInput3" style="width:60px;" maxlength="5" value="<?php echo $kreditAcc; ?>"/></span>
                <span id="spanKreditAccName" style="font-family:'Arial Narrow';"><?php echo $debitAccName; ?>&nbsp;</span>
            </td>
        </tr>
        <tr>
            <td height="22" class="">&nbsp;&nbsp;&nbsp;List Account</td>
        ...
        <tr>
            ...
            <td valign="middle">
                <input type="text" name="voucher" id="voucher" class="elementInput3" style="width:60px;" maxlength="5"  value="<?php echo $voucher; ?>" />
            </td>
        </tr>
        <tr>
            <td height="22">Reference</td>
            <td valign="middle">
                <input type="text" name="reference" id="reference" class="elementInput3" style="width:60px;" maxlength="5" value="<?php echo $reference; ?>"/>
            </td>
        </tr>
        <tr>
    ...
    <td valign="top">
        ...
        <tr>
            ...
            <td class="elementTeks">
            <input type="text" name="tglJurnal" id="tglJurnal" class="elementInput3" style="width:65px;" value="<?php echo $journalDate; ?>"/>
        ...
        <tr>
            ...
            <td class="elementTeks">
            <input type="text" name="dueDayRet" id="dueDayRet" class="elementInput3" style="width:25px;" maxlength="3" onkeyup="pilihDueDayRet();" value="<?php echo $dueDay; ?>"/>&nbsp;<span class="spanKalender" style="">(Day)</span>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td height="22" class="">&nbsp;Mail/Invoice No</td>
            <td class="elementTeks">
				<input type="text" class="elementInput3" id="mailInvNo" name="mailInvNo" style="width:275px;" value="<?php echo $mailInvNo; ?>">
            </td>
        </tr>
        ...
        <tr>
            <td align="right" colspan="2">
				...
				{ 
					...
					//$deducAmt = number_format( $CInvReg->detilSplitTemp($idMailInvGet, $userIdLogin, "deduction", $i, "amount"), 2, ".", ",");
					$deducDesc = $CInvReg->detilSplitTemp($idMailInvGet, $userIdLogin, "deduction", $i, "description"); ?>
<tr>
    <td align="left" height="22">
        <input type="text" id="deducAcc<?php echo $i ?>" name="deducAcc<?php echo $i ?>" class="elementInput3" maxlength="5" style="width:99%;" value="<?php echo $deducAcc; ?>" 
        onBlur="simpanSplitCred(this.value, 'deduction', '<?php echo $i ?>', 'account');">
    </td>
    <td align="center">
        <input type="text" id="deducAmount<?php echo $i ?>" name="deducAmount<?php echo $i ?>" class="elementInput3" style="width:99%;text-align:right;" value="<?php echo $deducAmt; ?>"
        onBlur="simpanSplitCred(this.value, 'deduction', '<?php echo $i ?>', 'amount');" onkeyup="hanyaAngkaDed<?php echo $i ?>();return false;">
    </td>
    <td align="right">
        <input type="text" id="deducReason<?php echo $i ?>" name="deducReason<?php echo $i ?>" class="elementInput3" maxlength="70" style="width:99.7%;" value="<?php echo $deducDesc; ?>"
        onBlur="simpanSplitCred(this.value, 'deduction', '<?php echo $i ?>', 'description');" onfocus="focusDescription(this.id, '<?php echo mysql_escape_string( $remark ); ?>');">
    </td>
</tr>
		  <?php } ?>
                </table>
        ...
        <tr>
            <td align="right" colspan="2">
				...
				for($ii=1;$ii<=5;$ii++) 
				{
					...
					//$deducAmt = number_format( $CInvReg->detilSplitTemp($idMailInvGet, $userIdLogin, "additional", $i, "amount"), 2, ".", ",");
...
<tr>
    ...
    <input type="hidden" id="incomingAmt" name="incomingAmt" value="<?php echo str_replace(",","",$amount); ?>" style="width:100px;">
    <input type="hidden" id="finalAmt" name="finalAmt" value="<?php echo str_replace(",","",$amount); ?>" style="width:100px;">
    <input type="hidden" id="totalCredAmt" name="totalCredAmt" value="<?php echo str_replace(",","",$amount); ?>" style="width:100px;"> 
    <input type="hidden" id="totalDebAmt" name="totalDebAmt" value="<?php echo str_replace(",","",$amount); ?>" style="width:100px;">
    <input type="hidden" id="balanceAmt" name="balanceAmt" value="" style="width:100px;">  
        ...
        <button type="button" id="btnCloseErase" class="btnStandar" onclick="closeAndErase();">
            ...
            <tr>
                <td align="center"><img src="../picture/exclamation-red.png" style="vertical-align:middle;"/><span style="vertical-align:middle;margin-left:4px;">CLOSE & ERASE</span></td>
            </tr>
            </table>
        </button>
        <button type="button" class="btnStandar" id="btnTransfer" onclick="pilihBtnSaveRet();">
            ...
            <tr>
                <td align="center"><img src="../picture/disk-black.png" style="vertical-align:middle;"/><span style="vertical-align:middle;margin-left:4px;">TRANSFER</span></td>
            </tr>
            </table>
        </button>
        <button type="button" id="btnReset" class="btnStandar" onclick="formUbahProcessRet.reset(); fungsiReset();">
            <table cellpadding="0" cellspacing="0" width="63" height="30">
            <tr>
                <td align="center"><img src="../picture/arrow-return-180-left.png" style="vertical-align:middle;"/><span style="vertical-align:middle;margin-left:4px;">RESET</span></td>
            </tr>
            </table>
        </button>
    </td>
...
<tr>
	<td height="30">
    	<button class="btnStandar" id="btnAddDesc" title="ADD NEW DESCRIPTION" style="width:50px;height:22px;" onclick="klikBtnAddDesc();return false;">
            <table cellpadding="0" cellspacing="0" width="100%" height="100%">
            <tr>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total (CR) : <span id="spanTotalCredAmt" style="font-size:12px;color:#333;"><?php echo $amount; ?></span>
...
<tr>
	<td valign="top">
    	<div id="divIframeList" style="position:inherit; border: solid 1px #CCC; top:0px; left:0px;text-align:left;width:475px;height:297px;z-index:1;">        
    		<iframe width="100%" height="100%" src="../templates/halSplitDebList.php?idMailInv=<?php echo $idMailInvGet; ?>" target="iframeSplitDebList" name="iframeSplitDebList" id="iframeSplitDebList" frameborder="0" marginwidth="0" marginheight="0" scrolling="yes" class="" style="z-index:0;"></iframe>
        </div>
    </td>
</tr>
<tr>
...
window.onload = function()
{
	...
	// INI TARO BAWAH ATAS PERINTAH PAK HENDRA, KARENA SKRIP MASKING ADA ERORNYA WALOPUN JALANA TAPI KADANG SKRIP SETELAH NYA TIDAK JALAN MAKA HARUS DITEMPATKAN PALING BAWAH
