...
//$echo.= "<tr><td>------------------------------------------------------------------------------------------------------------------------------------</td></tr>";
				...
				for($i=1;$i<=5;$i++)
				{
					...
					if($addiAcc != "")
					{
						$koneksiOdbcAcc->odbcExec($koneksiOdbcAccId, "INSERT INTO ".$dbAccounting." 
						(Company, Source, Bookdate, Voucher, Refnumber, Invoiceno, Pono, Bookdesc, Vessel, Account, Subacct, Subcode, Currcy, Booksts, Amount, Diffcur, Codests, Entrydate, Entryuser, Progdebug) VALUES 
						('".$compcode."', '".$sourcePost."', '".$bookDate."', '".$voucherPost."', '".$refNumber."', '".substr($invNo, 0, 16)."', '".$poNo."', '".substr($CPublic->ms_escape_string( $addiReason ), 0, 70)."', '".$addiVslCode."', '".$addiAcc."', '', '".$subCodePost."', '".$invCurr."', 'DB', '".number_format((float)$addiAmount, 2, '.', '')."', '".$invCurr."', '^', '".$entryDateMSSQL."', '".$userName."', 'Transfer JE:".$batchnoGet."')");
						
						$CKoneksiInvReg->mysqlQuery("INSERT INTO tblsplit (idmailinv, userid, fieldaksi, urutan, pay, booksts, account, amount, vslcode, description, addusrdt) VALUES ('".$idMailInvGet."', '".$userIdLogin."', 'additional', '".$i."', '".$addiCekPay."', 'DB', '".$addiAcc."', '".number_format((float)$addiAmount, 2, '.', '')."', '".$addiVslCode."', '".$addiReason."', '".$userWhoActNew."')", $CKoneksiInvReg->bukaKoneksi());
						
						$CHistory->updateLogInvReg($userIdLogin, "Simpan Invoice Returned (DEBIT) (INSERT INTO ".$dbAccounting." (Company = <b>".$compcode."</b>, Source = <b>".$sourcePost."</b>, Bookdate = <b>".$bookDate."</b>, Voucher = <b>".$voucherPost."</b>, Refnumber = <b>".$refNumber."</b>, Invoiceno = <b>".substr($invNo, 0, 16)."</b>, Pono = <b>".$poNo."</b>, Bookdesc = <b>".substr($CPublic->ms_escape_string( $addiReason ), 0, 70)."</b>, Vessel = <b>".$addiVslCode."</b>, Account = <b>".$addiAcc."</b>, Subacct =, Subcode = <b>".$subCodePost."</b>, Currcy = <b>".$invCurr."</b>, Booksts = <b>'DB'</b>, Amount = <b>".number_format((float)$addiAmount, 2, '.', '')."</b>, Diffcur = <b>".$invCurr."</b>, Codests = <b>'^'</b>, Entrydate = <b>".$entryDateMSSQL."</b>, Entryuser = <b>".$userName."</b>, Progdebug = <b>Transfer JE:".$batchnoGet."</b>)");
...
//$echo.= "<tr><td>------------------------------------------------------------------------------------------------------------------------------------</td></tr>";
				...
				for($i=1;$i<=5;$i++)
				{
					...
					if($deducAcc != "")
					{
						$koneksiOdbcAcc->odbcExec($koneksiOdbcAccId, "INSERT INTO ".$dbAccounting." 
						(Company, Source, Bookdate, Voucher, Refnumber, Invoiceno, Pono, Bookdesc, Vessel, Account, Subacct, Subcode, Currcy, Booksts, Amount, Diffcur, Codests, Entrydate, Entryuser, Progdebug) VALUES 
						('".$compcode."', '".$sourcePost."', '".$bookDate."', '".$voucherPost."', '".$refNumber."', '".substr($invNo, 0, 16)."', '".$poNo."', '".substr($CPublic->ms_escape_string( $deducReason ), 0, 70)."', '".$deducVslCode."', '".$deducAcc."', '', '".$subCodePost."', '".$invCurr."', 'CR', '".number_format((float)$deducAmount, 2, '.', '')."', '".$invCurr."', '^', '".$entryDateMSSQL."', '".$userName."', 'Transfer JE:".$batchnoGet."')");
						
						$CKoneksiInvReg->mysqlQuery("INSERT INTO tblsplit (idmailinv, userid, fieldaksi, urutan, booksts, account, amount, vslcode, description, addusrdt) VALUES ('".$idMailInvGet."', '".$userIdLogin."', 'deduction', '".$i."', 'CR', '".$deducAcc."', '".number_format((float)$deducAmount, 2, '.', '')."', '".$deducVslCode."', '".$deducReason."', '".$userWhoActNew."')", $CKoneksiInvReg->bukaKoneksi());
						
						$CHistory->updateLogInvReg($userIdLogin, "Simpan Invoice Returned (CREDIT) (INSERT INTO ".$dbAccounting." (Company = <b>".$compcode."</b>, Source = <b>".$sourcePost."</b>, Bookdate = <b>".$bookDate."</b>, Voucher = <b>".$voucherPost."</b>, Refnumber = <b>".$refNumber."</b>, Invoiceno = <b>".substr($invNo, 0, 16)."</b>, Pono = <b>".$poNo."</b>, Bookdesc = <b>".substr($CPublic->ms_escape_string( $deducReason ), 0, 70)."</b>, Vessel = <b>".$deducVslCode."</b>, Account = <b>".$deducAcc."</b>, Subacct =, Subcode = <b>".$subCodePost."</b>, Currcy = <b>".$invCurr."</b>, Booksts = <b>CR</b>, Amount = <b>".number_format((float)$deducAmount, 2, '.', '')."</b>, Diffcur = <b>".$invCurr."</b>, Codests = <b>'^'</b>, Entrydate = <b>".$entryDateMSSQL."</b>, Entryuser = <b>".$userName."</b>, Progdebug = <b>Transfer JE:".$batchnoGet."</b>)");
...
//$echo.= "<tr><td>------------------------------------------------------------------------------------------------------------------------------------</td></tr>";
				...
				while($rowSplit = $CKoneksiInvReg->mysqlFetch($querySplit))
				{
					$koneksiOdbcAcc->odbcExec($koneksiOdbcAccId, "INSERT INTO ".$dbAccounting." 
					(Company, Source, Bookdate, Voucher, Refnumber, Invoiceno, Pono, Bookdesc, Vessel, Account, Subacct, Subcode, Currcy, Booksts, Amount, Diffcur, Codests, Entrydate, Entryuser, Progdebug) VALUES 
					('".$compcode."', '".$sourcePost."', '".$bookDate."', '".$voucherPost."', '".$refNumber."', '".substr($invNo, 0, 16)."', '".$poNo."', '".substr($CPublic->ms_escape_string( $rowSplit['description'] ), 0, 70)."', '".$rowSplit['vslcode']."', '".$rowSplit['account']."', '', '".$subCodePost."', '".$invCurr."', 'DB', '".number_format((float)$rowSplit['amount'], 2, '.', '')."', '".$invCurr."', '^', '".$entryDateMSSQL."', '".$userName."', 'Transfer JE:".$batchnoGet."')");
...
<tr>
    ...
    <td align="center">
    	<input type="text" id="deducVslCode<?php echo $i ?>" name="deducVslCode<?php echo $i ?>" class="elementInput3" maxlength="3" style="width:99%;text-align:right;" value="<?php echo $vslCode; ?>" onblur="simpanSplitCred(this.value, 'deduction', '<?php echo $i ?>', 'vslCode');" onkeyup="return false;">
        </td>
    <td align="right">
...
<div id="divKontenSplitDeb" style="position:absolute;left:0px;top:106px; z-index:3;width:540px;background-color:#FFC;border-width:2px; border-color:#FC0;display:none;" class="tabelBorderAll">
...
<tr>
	<td valign="top">
    	<div id="divIframeList" style="position:inherit; border: solid 1px #CCC; top:0px; left:0px;text-align:left;width:525px;height:297px;z-index:1;">        
...
window.onload = function()
{
	...
	$("#dateReturned").focus(); // SET FOCUS SALAH SATU ELEMEN KARENA KADANG2 SUKA TIDAK BISA DIISI ELEMENT INPUT TEKS DI HALAMAN INI
}
<?php
if($tutupWindow == "yes")
{
