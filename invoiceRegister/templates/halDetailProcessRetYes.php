...
if($aksiPost  == "cancelInvRet")
{
	...
	{		
		$CKoneksiInvReg->mysqlQuery("INSERT INTO tblsplittemp (idmailinv, userid, fieldaksi, urutan, pay, booksts, account, amount, vslcode, description, addusrdt) VALUES ('".$idMailInvGet."', '".$userIdLogin."', '".$rowSplit['fieldaksi']."', '".$rowSplit['urutan']."', '".$rowSplit['pay']."', '".$rowSplit['booksts']."', '".$rowSplit['account']."', '".$rowSplit['amount']."', '".$rowSplit['vslcode']."', '".substr($CPublic->ms_escape_string( $rowSplit['description'] ), 0, 70)."', '".$rowSplit['addusrdt']."')");
	}
	$CKoneksiInvReg->mysqlQuery("DELETE FROM tblsplit WHERE idmailinv='".$idMailInvGet."';");
...
$splitCreAcc = $CInvReg->detilMailInv($idMailInvGet, "kreditsplit")=="Y"?"YES":"NO";
$warnaDebAcc = $splitDebAcc == "YES"?"#900;":"#485a88;";
$disBtnView = $splitDebAcc == "YES"?"enabled":"disabled";
$disBtnViewCre = $splitCreAcc == "YES"?"enabled":"disabled";
$classBtnView = $splitDebAcc == "YES"?"btnStandar":"btnStandarDis";
$classBtnViewCre = $splitCreAcc == "YES"?"btnStandar":"btnStandarDis";
...
<div id="idHalUbahProcessRet" style="position:absolute;top:9px;left:15px;border:solid 0px #666;z-index:auto;">
    <table cellpadding="0" cellspacing="0" width="930" height="545"
        ...
        <form method="post"
            action="halDetailProcessRetYes.php?batchno=<?php echo $batchnoGet; ?>&idMailInv=<?php echo $idMailInvGet; ?>"
            enctype="multipart/form-data" id="formCancelRet" name="formCancelRet">
            ...
            <tr>
                <td colspan="2" align="center">
                    <span
                        style="font-size:15px;font-family:sans-serif;font-weight:bold;color:#485a88;text-decoration:underline;">DETAIL
            ...
            <tr>
                <td width="50%" valign="top">
                    <table cellpadding="0" cellspacing="0" width="435" class="tabelBorderTopJust"
                        ...
                        <tr>
                            ...
                            <td class="elementTeks" valign="middle"><?php echo $debitAcc." ( ".$debitAccName." )"; ?>
                            </td>
                        </tr>
                        <tr>
                            <td height="22" class="">&nbsp;&nbsp;&nbsp;Split Account</td>
                            <td style="position:inherit;"><span id="splitDebAccNo" class="elementTeks"
                                    style="position:relative;bottom:3px;color:<?php echo $warnaDebAcc; ?>"><?php echo $splitDebAcc; ?></span>
                                <button type="button" class="<?php echo $classBtnView; ?>" id="btnViewSplitDeb"
                                    title="SPLIT DEBIT ACCOUNT"
                                    style="position:absolute;left:170px;width:62px;height:20px;"
                                    onclick="klikBtnViewDebYes();" <?php echo $disBtnView; ?>>
                        ...
                        <tr>
                            <td height="22" class="">&nbsp;&nbsp;&nbsp;Split Account</td>
                            <td style="position:inherit;"><span id="splitDebAccNo" class="elementTeks"
                                    style="position:relative;bottom:3px;color:<?php echo $warnaDebAcc; ?>"><?php echo $splitCreAcc; ?></span>
                                <button type="button" class="<?php echo $classBtnViewCre; ?>" id="btnViewSplitCre"
                                    title="SPLIT CREDIT ACCOUNT"
                                    style="position:absolute;left:170px;width:62px;height:20px;"
                                    onclick="klikBtnViewCreYes();" <?php echo $disBtnViewCre; ?>>
                                    <table cellpadding="0" cellspacing="0" width="100%" height="100%">
                                        <tr>
                                            <td align="center" width="22"><img src="../picture/eye--exclamation.png" />
                                            </td>
				...
				for($i=1;$i<=5;$i++) 
				{
					$deducAcc = $CInvReg->detilSplitYes($idMailInvGet, "deduction", $i, "account");
					$amountt = number_format( $CInvReg->detilSplitYes($idMailInvGet, "deduction", $i, "amount"), 2, ",", ".");
					$deducAmt = $amountt=="0,00"?"":$amountt;
					$vslCode = $CInvReg->detilSplitYes($idMailInvGet, "deduction", $i, "vslcode");
					$deducDesc = $CInvReg->detilSplitYes($idMailInvGet, "deduction", $i, "description");
					?>

                                    <tr>
                                        <td align="left" height="22"><input type="text" class="elementInput3"
                                                maxlength="5" style="width:99%;" value="<?php echo $deducAcc; ?>"
                                                readonly></td>
                                        <td align="center"><input type="text" class="elementInput3"
                                                style="width:99%;text-align:right;" value="<?php echo $deducAmt; ?>"
                                                readonly></td>
                                        <td align="center"><input type="text" class="elementInput3"
                                                style="width:99%;text-align:right;" value="<?php echo $vslCode; ?>"
                                                readonly></td>
                                        <td align="right"><input type="text" class="elementInput3" maxlength="70"
                                                style="width:99.7%;" value="<?php echo $deducDesc; ?>" readonly></td>
                                    </tr>
                                    <?php
				}
				?>
        ...
        <tr>
            <td align="right" colspan="2">
				...
				for($ii=1;$ii<=5;$ii++) 
				{
					...
					$addiVslCode = $CInvReg->detilSplit($idMailInvGet, $userIdLogin, "additional", $ii, "vslcode");
					$descAcc = $CInvReg->detilSplit($idMailInvGet, $userIdLogin, "additional", $ii, "description");
					?>
					
<tr>
	<td align="center" class="<?php echo $classPay; ?>" style="background-color:#FFF;cursor:pointer;"><input type="checkbox" <?php echo $addiPay; ?> /></td>
	<td align="left" height="22"><input type="text" class="elementInput3" maxlength="5" style="width:99%;" value="<?php echo $addiAcc; ?>" readonly></td>
	<td align="center"><input type="text" class="elementInput3" style="width:99%;text-align:right;" value="<?php echo $amountAcc; ?>" readonly></td>
	<td align="center"><input type="text" class="elementInput3" style="width:99%;text-align:right;" value="<?php echo $addiVslCode; ?>" readonly></td>
	<td align="right"><input type="text" class="elementInput3" maxlength="70" style="width:99.7%;" value="<?php echo $descAcc; ?>" readonly></td>
</tr>
				<?php
				}
				?>
            ...
            <tr>
                <td colspan="2" height="40" align="center" class="tabelBorderTopJust" style="border-style:dotted;">
                    <button type="button" id="btnClose" class="btnStandar" style="width:100px;height:32px;"
                        onclick="tutupDetailProcess('Y');">
                        <table cellpadding="0" cellspacing="0" width="100%" height="100%">
                            <tr>
                    ...
                    <button type="button" id="btnCancelTrf" class="btnStandar"
                        style="width:127px;height:32px;display:inline;" onclick="pilihBtnCancelTrf();">
                        <table cellpadding="0" cellspacing="0" width="100%" height="100%">
                            <tr>
                                <td align="center"><img src="../picture/hourglass--pencil.png"
                                        style="vertical-align:middle;" /><span
                                        style="vertical-align:middle;margin-left:4px;">CANCEL TRANSFER</span></td>
                            </tr>
                        </table>
                    </button>
                </td>
...
<div id="divKontenSplitDeb"
    style="position:absolute;left:0px;top:106px; z-index:3;width:490px;background-color:#FFC;border-width:2px; border-color:#FC0;display:none;"
        ...
        <tr>
            <td height="30">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total (CR) : <span id="spanTotalCredAmt"
                    style="font-size:12px;color:#333;"><?php echo number_format($amount, 2, ".", ","); ?></span>
        ...
        <tr>
            <td valign="top">
                <div id="divIframeList"
                    style="position:inherit; border: solid 1px #CCC; top:0px; left:0px;text-align:left;width:475px;height:297px;z-index:1;">
                    <iframe width="100%" height="100%"
                        src="../templates/halSplitDebListYes.php?idMailInv=<?php echo $idMailInvGet; ?>"
...
<div id="divCloseSplitCre" style="position:absolute;left:465px;top:110px;z-index:4;display:none;">
    <button type="button" class="btnStandar" id="btnCloseSplitDeb" title="" onclick="klikBtnCloseSplitCreYes();">
        <table cellpadding="0" cellspacing="0" width="22" height="19">
            <tr>
                <td align="center" valign="bottom"><img src="../picture/cross.png" height="14" /></td>
            </tr>
...
<div id="divKontenSplitCre"
    ...
    <table cellpadding="0" cellspacing="0" width="475" height="350" align="center"
        ...
        <tr>
            <td valign="top">
                <div id="divIframeList"
                    style="position:inherit; border: solid 1px #CCC; top:0px; left:0px;text-align:left;width:475px;height:297px;z-index:1;">
                    <iframe width="100%" height="100%"
                        src="../templates/halSplitCreListYes.php?idMailInv=<?php echo $idMailInvGet; ?>"
        ...
        <tr>
            <td height="30">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total
                (CR) : <span id="spanTotalDebAmt" style="font-size:12px;color:#333;">&nbsp;</span>
            </td>
        </tr>
    </table>
</div>
