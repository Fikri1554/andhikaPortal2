        ...
        <tr>
            <td align="right" colspan="2">
				...
				for($i=1;$i<=5;$i++) 
				{
					...
					$vslCode = $CInvReg->detilSplit($idMailInvGet, $userIdLogin, "deduction", $i, "vslcode");
					$deducDesc = $CInvReg->detilSplit($idMailInvGet, $userIdLogin, "deduction", $i, "description");
					?>

<tr>
    <td align="left" height="22"><input type="text" class="elementInput3" maxlength="5" style="width:99%;" value="<?php echo $deducAcc; ?>" readonly></td>
    <td align="center"><input type="text" class="elementInput3" style="width:99%;text-align:right;" value="<?php echo $deducAmt; ?>" readonly></td>
    <td align="center"><input type="text" class="elementInput3" style="width:99%;text-align:right;" value="<?php echo $vslCode; ?>" readonly></td>
    <td align="right"><input type="text" class="elementInput3" maxlength="70" style="width:99.7%;" value="<?php echo $deducDesc; ?>" readonly></td>
</tr>
				<?php
				}
				?>
