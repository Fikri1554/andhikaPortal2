...
{	
	...
	if(saveInvRet == "Y")
	{
		 parent.document.getElementById('btnRetDetail').onclick = function onclick(){	parent.openThickboxWindow('klikBtnDetailAck');return false;	}
	...
	if(saveInvRet == "N")
	{
		parent.document.getElementById('btnRetDetail').onclick = function onclick(){	parent.openThickboxWindow('klikBtnDetailRet');return false;	}
	}
	<?php
	echo "\n\r";
	if($userJenisInvReg == "user")
