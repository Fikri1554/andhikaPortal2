...
/*	$tpl = new myTemplate("templates/report.html");
	...
	$html.= "<tr><td align=\"center\">
			...
			<tr align=\"center\" height=\"23px;\" bgcolor=\"#E9E9E9\" class=\"style3\">
				<td align=\"center\" width=\"5%\" class=\"tabelBorderRightNull\">
					No.
				</td>
				<td colspan=\"2\" align=\"center\" width=\"81%\" class=\"tabelBorderRightNull\">
				<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" width=\"100%\" class=\"style3\">
					...
					<tr><td align=\"center\">Information</td></tr>
				</table>
				</td>
				<td align=\"center\" width=\"14%\" class=\"tabelBorderAll\">
					Term(hour)
				</td>
			</tr>";
	$i=1;
	...
	while($row = $CKoneksi->mysqlFetch($query))
	{
		$total = $total + $COtherReport->pheonwj($row['userid'], $dateForm, $dateTo);
		
		$border = "class=\"tabelBorderTopRightNull\"";
		if($i!=1)
		{
			$border = "class=\"tabelBorderRightNull\"";
		}
		if($i%2 == 1)
		{
			$bgColor = "";
		...
		if($COtherReport->pheonwj($row['userid'], $dateForm, $dateTo) != 0)
		{
	$html.=	"<tr height=\"20px\" class=\"style5\" ".$bgColor.">
				<td ".$border." align=\"center\">".$i."</td>
				<td colspan=\"2\" class=\"tabelBorderTopRightNull\">&nbsp;&nbsp;".$row['userfullnm']."</td>
				<td align=\"center\" class=\"tabelBorderTopNull\">
					<b>".$COtherReport->pheonwj($row['userid'], $dateForm, $dateTo)."</b>
				</td>
			</tr>";
		$j = 1;
		$queryAct = $CKoneksi->mysqlQuery("SELECT * FROM tblactivity 
					WHERE ownerid = ".$row['userid']." AND 
	...
	$html.=	"<tr height=\"17px\" class=\"style5\">
				...
				<td class=\"tabelBorderBottomJust\">".$rowAct['relatedinfo']."</td>
				<td align=\"center\" class=\"tabelBorderTopNull\">".$COtherReport->selisihJam($rowAct['fromtime'], $rowAct['totime'])."</td>
			</tr>";
		$j++;}
		$i++;}
	}
	...
	//$html.= "<tr><td style=\"position:absolute;bottom:-0%;width:99%;right:7%;font:0.6em sans-serif;\" class=\"tabelBorderAllNull\">Page 1 of 1</td></tr>";
	...
	{	
		...
		$html.= "<tr><td align=\"center\">
				...
				<tr align=\"center\" height=\"23px;\" bgcolor=\"#E9E9E9\" class=\"style3\">
					...
					<td colspan=\"2\" align=\"center\" width=\"81%\" class=\"tabelBorderBottomLeftNull\">
					<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" width=\"100%\" class=\"style3\">
						<tr><td class=\"tabelBorderBottomJust\" align=\"center\">Name</td></tr>
						<tr><td align=\"center\">Information</td></tr>
					</table>
		...
		while($row = $CKoneksi->mysqlFetch($query))
		{
			...
			if($namaSeb != 	$row['ownername'])
			{
				...
				$html.=	"<tr height=\"20px\" class=\"style5\" ".$bgColor.">
							...
							<td colspan=\"2\" ".$border1.">&nbsp;&nbsp;".$row['ownername']."</td>
