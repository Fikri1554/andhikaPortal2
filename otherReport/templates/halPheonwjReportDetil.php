...
AND project='pheonwj' AND deletests=0 ORDER BY idactivity ASC;");
	...
	{
		$date = $rowAct['tanggal']."/".$rowAct['bulan']."/".substr($rowAct['tahun'],2,2);
                    ...
                    <tr>
                        ...
                        <table id="tbl<?php echo $i.$j;?>" cellpadding="0" cellspacing="0" border="0" width="100%" <?php echo $bg;?>>
                        	<tr valign="top">
                                ...
                                <td <?php echo $type2;?> align="center" width="8%"><?php echo $date;?>
                                </td>
                                <td <?php echo $type3;?> width="1%"></td>
                                <td <?php echo $type2;?> align="left" width="74%"><?php echo $rowAct['relatedinfo'];?>
                                </td>
