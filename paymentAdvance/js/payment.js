...
function klikRowBatch(idMailInv, transNo, amount, paid, cancelPaid, reasonCancelPaid, payType, bankCode, voucher, reference, chequeNumber, datePaid, currency, amtConv, currConv, adjAcc, adjAmt, paidOptYesNo, viewFile)
{
...
function klikBtnRetBatch()
{
	...
	$('#tdTransNo').html( $('#transNo').val()+" "+btnViewNya );
