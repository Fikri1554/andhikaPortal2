...
function rejectData() {
    ...
    setTimeout(function() {
        document.getElementById('hrefThickbox').href = "templates/halRejectData.php?aksi=display&idEdit=" +
            dtChecked +
            "&rejectName=confirm&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=200&width=900&modal=true";
...
<div class="wrap">
    ...
    <div class="namaAplikasi"> CONFIRM PAYMENT </div>
</div>
...
<div class="kotakPaymentAdv">
    ...
    <div class="kotakBtnAtas">
        ...
        <button class="btnStandarTabPilih" id="" title="CONFIRM" onclick="return false;">
    ...
    <div class="kotakBtnTengah">
        ...
        <button class="btnStandarDis" id="btnApprove" title="Confirm Data" onclick="confirmData();return false;"
            disabled="disabled">
        ...
        <button class="btnStandarDis" id="btnReject" title="Reject Data" onclick="rejectData();return false;"
            disabled="disabled">
            <table width="100" height="24">
                <tr>
