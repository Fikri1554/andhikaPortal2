...
function klikRowVoucher(batchno, transferAcct, voucherType, paidTo, company, payType, bankCode, voucher, reference, chequeNumber, invNo, jobNo, datePaid, curr, amount, additional,txtBarcodeHid)
{
	kosongkanElementHid();
