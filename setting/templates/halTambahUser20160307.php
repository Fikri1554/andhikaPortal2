...
if($halamanPost == "simpanNewUser")
{
	...
	$CKoneksi->mysqlQuery("INSERT INTO login (empno, username, userpass, userfullnm, userinit, active, nmdiv, nmdept, nmjabatan, useremail, addusrdt)VALUES ('".$empNo."', '".$username."', md5('".$password."'), '".$userfullnm."', '".$userInit."', '".$active."', '".$nmDiv."', '".$nmDept."', '".$nmJab."', '".$email."', '".$CPublic->userWhoAct()."');");
...
if($halamanPost == "simpanEditUser")
{
	...
	if($password == "")
	{
		$CKoneksi->mysqlQuery("UPDATE login SET username = '".$username."', useremail = '".$email."', active = '".$active."', kddiv = '".$divisi."', nmdiv='".$nmDiv."', nmdept='".$nmDept ."', nmjabatan='".$nmJab."', updusrdt = '".$CPublic->userWhoAct()."' WHERE userid = '".$userId."' AND deletests=0");
	...
	elseif($password != "")
	{
		$CKoneksi->mysqlQuery("UPDATE login SET username = '".$username."', useremail = '".$email."', userpass = md5('".$password."'), active = '".$active."', kddiv = '".$divisi."', nmdiv='".$nmDiv."', nmdept='".$nmDept ."', nmjabatan='".$nmJab."', updusrdt = '".$CPublic->userWhoAct()."' WHERE userid = '".$userId."' AND deletests=0");
    ...
    <td colspan="2" class="tdMyFolder" bgcolor="#FFFFFF" height="437" valign="top">
        ...
        <tr>
            ...
            <form action="halTambahUser.php" method="post" enctype="multipart/form-data" id="formUser" name="formUser">
                ...
                <tr valign="top">
                    <td height="28" width="23%" align="left">Employee name</td>
                ...
                <tr valign="top" align="left">
                    <td height="28" align="left">Active</td>
                    <td>
        			<?php
                ...
                <tr valign="top">
                    <td height="28" align="left">Division</td>
                    <td align="left">
