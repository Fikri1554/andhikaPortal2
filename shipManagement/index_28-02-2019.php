...
elseif($aksiPost == "halamanUploadFileExcel")
{
	$tpl->Assign("halaman2", "> <span class=\"teksMyFolder\" style=\"color:#369;text-decoration:underline;font-size: 14px;\">UPLOAD FILE</span>");
}
elseif($aksiPost == "halamanUploadExcelNoon")
{
...
elseif($aksiPost == "halamanUploadExcelOil")
{
	...
	$tpl->Assign("halaman2", "> <span class=\"teksMyFolder\" style=\"color:#369;text-decoration:underline;font-size: 14px;\">UPLOAD FILE</span>");
	$tpl->Assign("halaman3", "> <span class=\"teksMyFolder\" style=\"color:#369;font-size: 14px;text-decoration:underline;\">OIL</span>");
}
elseif($aksiPost == "halamanUploadSummaryConsSpeed")
{
	...
	$tpl->Assign("halaman2", "> <span class=\"teksMyFolder\" style=\"color:#369;font-size: 14px;\">UPLOAD FILE</span>");
