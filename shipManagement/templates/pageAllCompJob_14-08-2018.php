...
$(document).ready(function() {
    ...
    $('#btnSave').click(function() {
        $.post('../shipManagement/class/actionNav.php', {
                partOf: $("#partName").val(),
                jobCode: $("#codeHeading").val(),
                compCode1: $("#compCode1").val(),
                compCode2: $("#compCode2").val(),
                compCode3: $("#compCode3").val(),
                compName: $("#compName").val(),
                plann: $("input[name='rdMaintenancePlan']:checked").val() + $("#txtMonthly").val() +
                    $("#txtWeekly").val() + $("#txtHourly").val(),
                lastDone: $("#lastDone").val(),
                nextDue: $("#nextDue").val(),
                idEdit: $("#idEdit").val()
            },
            function(data) {
...
<div class="archivesContainer" style="padding-bottom:50px;margin-top:10px;">
    <div class="equipName" style="padding:10px;">
        ...
        <button class="btnStandar" id="btnExport" style="width:80px;height:29px;" title="Export">
            <table cellpadding="0" cellspacing="0" width="100%" height="100%" border="0">
                <tr>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" border="1" id="tblDataJobComp">
            <thead>
                <tr style="background-color: #125362;color: #FFFFFF;height:30px;" align="center">
                    <th style="width: 5%;" colspan="2">Code</th>
    ...
    <div class="formComp" style="width:100%;min-height:250px;overflow: scroll;">
        <fieldset>
            <legend>
                <h3>&nbsp&nbsp Form Component & Job</h3>
            </legend>
            ...
            <table style="width: 100%;padding: 20px;" cellpadding="0" cellspacing="8">
                <tr>
                    ...
                    <td style="width: 7%;">
                        <input disabled="disabled" style="width: 70%;" type="text" name="codeHeading" id="codeHeading"
                            class="elementSearch">
                    </td>
                    <td style="width: 25%;">
                        {selectJobHeading}
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input type="text" disabled="disabled" name="compCode1" id="compCode1" class="elementSearch"
                            style="width: 5%;">
                        <input type="text" name="compCode2" id="compCode2" class="elementSearch" style="width: 5%;"
                            maxlength="2" onkeypress="return isNumberKey(event)">
                        <input type="text" name="compCode3" id="compCode3" class="elementSearch" style="width: 5%;"
                            maxlength="2" onkeypress="return isNumberKey(event)">
                        &nbsp
                        <input type="text" name="compName" id="compName" class="elementSearch" style="width: 65%;"
                            placeholder="Name">
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="4">
                        <input type="radio" name="rdMaintenancePlan" id="rdMaintenancePlan1" checked="true"
                            value="M">Monthly
                        ...
                        <input type="text" name="lastDone" id="lastDone" class="elementSearch"
                            style="width: 20%;margin-left: 30px;" placeholder="Last Done">
                        <input type="text" name="nextDue" id="nextDue" class="elementSearch"
                            style="width: 20%;margin-left: 10px;" placeholder="Next Due">
                    </td>
                </tr>
                <tr>
                    <td colspan="5" align="center" style="padding: 30px;">
                        <button class="btnStandar" id="btnSave" style="width:80px;height:29px;"
                            title="Display Own Shared Folder List">
                            <table cellpadding="0" cellspacing="0" width="100%" height="100%" border="0">
                                <tr>
                                    <td align="right" width="25"><img src="../picture/Floppy-Disk-blue-32.png"
                                            height="20" /> </td>
                                    <td align="center">Save</td>
                                </tr>
                            </table>
                        </button>
                        <button class="btnStandar" id="btnCancel" style="width:80px;height:29px;"
                            title="Display Own Shared Folder List">
                            <table cellpadding="0" cellspacing="0" width="100%" height="100%" border="0">
                                <tr>
                                    <td align="right" width="25"><img src="../picture/Button-Cross-blue-32.png"
                                            height="20" /> </td>
