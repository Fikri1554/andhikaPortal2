...
<script type="text/javascript">
	...
	function getExportPdf()
	{
		...
		var url = window.location.pathname+"pdf/cetakMaintenanceForecast.php/?aksi=ReportPdf&vessel="+vn+"";
...
<div class="archivesContainer" style="padding-bottom:50px;margin-top:10px;">
	<div class="navBtn" style="width:100%;min-height:0px;" >
		...
		<button class="btnStandar" id="btnExport" style="width:100px;height:29px; margin: 10px; float: right;" title="Cetak" {stBtnExport}>
     	...
     	<button class="btnStandar" onclick="getExportPdf();" id="btnExportPdf" style="width:100px;height:29px; margin: 10px; float: right;" title="Cetak PDF" {stBtnExport}>
        	<table cellpadding="0" cellspacing="0" width="100%" height="100%" border="0">
            	<tr>
                	<td align="right" width="25"><img src="../picture/filePdf.png" height="20"/> </td>
                    <td align="center">Export PDF</td>
              	</tr>
         	</table>
     	</button>
	</div>
