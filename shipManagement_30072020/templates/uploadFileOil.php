		...
		<fieldset>
			...
			<table border="1" cellpadding="0" cellspacing="0" width="100%" class="tabelBorderAll" style="font:0.9em sans-serif;font-weight:100;color:#485a88;border-style:dotted;padding: 10px;">
				...
				<tr>
					...
					<td height="22" style="color:#000;width:10%;" id="txtBunkerAtaMFO" align="center" class="tabelBorderAll"></td>
					...
					<td height="22" style="color:#000;width:10%;" id="txtBunkerAtaFW" align="center" class="tabelBorderAll"></td>
				...
				<tr>
					...
					<td height="22" style="color:#000;width:10%;" id="txtBunkerReplMFO" align="center" class="tabelBorderAll"></td>
					...
					<td height="22" style="color:#000;width:10%;" id="txtBunkerReplFW" align="center" class="tabelBorderAll"></td>
				...
				<tr>
					...
					<td height="22" style="color:#000;width:10%;" id="txtBunkerAtdMFO" align="center" class="tabelBorderAll"></td>
					...
					<td height="22" style="color:#000;width:10%;" id="txtBunkerAtdFW" align="center" class="tabelBorderAll"></td>
			...
			<table border="1" cellpadding="0" cellspacing="0" width="100%" class="tabelBorderAll" style="font:0.9em sans-serif;font-weight:100;color:#485a88;border-style:dotted;padding: 10px;">
				...
				<tr>
					<td height="22" style="color:#000;width:5%;background-color: #e4e4e4;" align="center" class="tabelBorderAll"></td>
					<td height="22" style="color:#000;background-color: #e4e4e4;" class="tabelBorderAll"></td>
					<td height="22" style="color:#000;width:8%;background-color: #e4e4e4;" align="center" class="tabelBorderAll">kl per hour</td>
