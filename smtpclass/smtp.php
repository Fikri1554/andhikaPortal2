 ...
 * smtp.php
 *
 * @(#) $Header: /opt2/ena/metal/smtp/smtp.php,v 1.56 2022/10/29 09:37:22 mlemos Exp $
 *
 */
...
<class>
	...
	<version>@(#) $Id: smtp.php,v 1.56 2022/10/29 09:37:22 mlemos Exp $</version>
...
{metadocument}
	<variable>
		...
		<type>STRING</type>
		<value>SMTP Class (http://www.phpclasses.org/smtpclass $Revision: 1.56 $)</value>
		<documentation>
...
{/metadocument}
*/
	var $user_agent='SMTP Class (http://www.phpclasses.org/smtpclass $Revision: 1.56 $)';
		...
		if($this->VerifyResultLines("220",$responses)>0)
		{
			...
			if($this->start_tls)
			{
				...
				&& $this->VerifyResultLines('220',$responses)>0))
				{
					...
					if(!($success = @stream_socket_enable_crypto($this->connection, 1, $this->cryptographic_method)))
