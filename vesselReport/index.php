...
if($userIdSession != "")
{
	...
	if($userJenisVslRep != "")
	{
		if($halamanPost == "halCop")
		{
			$tpl->AssignInclude("CONTENT_TENGAH","templates/halCop.html");
		}
		if($halamanPost == "halNoon")
		{
			$tpl->AssignInclude("CONTENT_TENGAH","templates/halNoon.html");
		}
		if($halamanPost == "halMorning")
		{
			$tpl->AssignInclude("CONTENT_TENGAH","templates/halMorning.html");
		}
		if($halamanPost == "halSetting")
		{
			$tpl->AssignInclude("CONTENT_TENGAH","templates/halSetting.html");
		}
		if($halamanPost == "halEop" || $halamanPost == "")
		{
			$tpl->AssignInclude("CONTENT_TENGAH","templates/halEop.html");
		}
		if($halamanPost == "halPort" || $halamanPost == "")
		{
			$tpl->AssignInclude("CONTENT_TENGAH","templates/halPort.html");
		}
	}
}
if($userJenis != "admin")
...
$tpl->Assign("userJenisVslRep", $userJenisVslRep);
...
$tpl->Assign("displayBtnSetting", "display:none;");
if($userJenisVslRep == "admin")
{
	$tpl->Assign("displayBtnSetting", "display:inline;");
}
if($halamanPost == "halSetting")
{ 
	$tpl->Assign("emailAddress", $CVslRep->CCEmailAddress());
}
else
{
	$tpl->Assign("userIdLogin", $userIdSession);
	$tpl->Assign("menuPilihVsl", $CVslRep->menuPilihVsl());
}
