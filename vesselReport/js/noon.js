...
function klikBtnRefresh()
{
	...
	loadIframe("iframeList", "templates/halNoonList.php?aksi=display&nmVsl="+$('#nmVsl').val());
...
{
	var idNoon = $("#idNoon").val();
	
	$('#formPrint').attr('action', 'halPrint.php?aksi=printNoon&idNoon='+idNoon);
	formPrint.submit();
}