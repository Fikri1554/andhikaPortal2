...
class Imapx
{
    ...
    */
    ...
    private $hostname = '192.168.168.99'; // here is your host name,
    private $username = 'vis@andhika.com'; // your server username ex: john@gmail.com
    private $password = 'abc123';
    private $port = 993;
    private $ssl = true; // If you use false then the server ignore ssl
    private $novalidate = true; // If novalidate true then your server use own validate certificate
    /*
        end configurations
    */
    ...
    */
    public function connect($host = null, $driver = null, $user = null, $password = null, $port = null, $ssl = null, $novalidate = null)
    {
		...
		//$this->stream = imap_open('{'.$this->hostname.$this->port.$this->novalidate.'}INBOX', $this->username, $this->password) or die('Cannot connect to Server: '.imap_last_error());
    ...
    */
    ...
    public function getInbox($page = 1, $perPage = 25, $sort = null)
    {
		...
		if($mails != "") // TAMBAHIN SENDIRI 20170315
