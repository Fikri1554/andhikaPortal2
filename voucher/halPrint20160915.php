...
if($aksiGet == "printVoucher")
{
	...
	$totalAmount = $CVoucher->detilVoucher($idVoucherGet, "amount");
	...
	if($currency == "IDR")
	{
		...
		$tpl->Assign("totalAmountWords", ucwords(strtolower( $totalAmountWords." Rupiah Saja" )));
	}
	if($currency == "USD")
	{
		$tpl->Assign("totalAmountWords", ucwords(strtolower( $CNumberWordsEng->convert_number_to_words($totalCurr, $totalAmount)))." US Dollar Only" );
	}	
