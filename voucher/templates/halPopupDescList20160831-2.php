...
<?php
		...
		<td>
			...
			<tr align=\"center\" valign=\"middle\">
				...
				&nbsp;<b>DESCRIPTION</b> <span style=\"font-size:18px;\">".$i."</span>&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"text\" value=\"".$row['keterangan']."\" id=\"desc".$idDesc."\" name=\"desc".$idDesc."\" class=\"elementInput\" style=\"width:300px;text-transform:uppercase;\" maxlength=\"110\" ".$disabled.">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					BOOK STS&nbsp;&nbsp;&nbsp;
					<select id=\"descBookSts".$idDesc."\" name=\"descBookSts".$idDesc."\" class=\"elementMenu\" style=\"width:45px;height:22px;vertical-align:top;\" ".$disabled.">
			...
			<tr valign=\"middle\">
				...
				<td width=\"151\">
					...
					<input type=\"text\" id=\"descAmount".$idDesc."\" name=\"descAmount".$idDesc."\" value=\"".$amount."\" class=\"elementInput\" style=\"width:110px;text-align:right;\" ".$disabled.">
				</td>
				<td width=\"50\">&nbsp;ACCT #</td>
				...
				<td width=\"91\"><input type=\"text\" id=\"subAcc".$idDesc."\" name=\"subAcc".$idDesc."\" value=\"".$row['subacc']."\" class=\"elementInput\" style=\"width:62px;\" maxlength=\"5\" ".$disabled."></td>
	...
	if($i !=  $jmlRow)
	{
		$tabelaaa.="<tr><td colspan=\"9\" class=\"tabelBorderLeftRightNull\" style=\"border-style:dotted;\" height=\"5\" bgcolor=\"#FFFFFF\"></td></tr>";
	}
	else
	{
		$tabelaaa.="<tr><td colspan=\"9\" class=\"tabelBorderTopJust\" style=\"border-style:dotted;\" height=\"5\" bgcolor=\"#FFFFFF\"></td></tr>";
	}
