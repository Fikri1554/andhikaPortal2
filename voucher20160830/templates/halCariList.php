...
<div style="height:298px;overflow-y: scroll;">
	...
	if($aksiGet == "lakukanCari")
    {
		...
		$tabel = "";
        $i=0;
        $query = $CKoneksiVoucher->mysqlQuery("SELECT *, DATE(SUBSTRING(addusrdt, 7, 8)) AS entrydate FROM tblvoucher WHERE ".$paramCari." deletests=0 ORDER BY companyname ASC;", $CKoneksiVoucher->bukaKoneksi());
