...
?>
	 <div style="position:inherit; border: solid 1px #CCC; width:100%; height:204px; text-align:center; background-color:#FFF;">
        ...
        <div style="position:relative; top:5px; font:1.2em sans-serif; line-height:30px; color:#096;">
        	<span style=" font:0.8em sans-serif;">BATCHNO</span>&nbsp;<b><?php echo $CPublic->zerofill($idVoucherGet, 6); ?></b>
        </div>
        ...
        <div style="position:relative; top:10px;">
            <button class="btnStandar" id="" title="CLOSED" onclick="parent.closePopupNewVoucher('<?php echo $idVoucherGet; ?>', $('#moreVoucher:checked').val());return false;">
...
?>
	 <div style="position:inherit; border: solid 1px #CCC; width:100%; height:174px; text-align:center; background-color:#FFF;">
        ...
        <div style="position:relative; top:5px; font:1.2em sans-serif; line-height:30px; color:#096;">
        	<span style=" font:0.8em sans-serif;">BATCHNO</span>&nbsp;<b><?php echo $CPublic->zerofill($idVoucherGet, 6); ?></b></div>
        <div style="position:relative; top:10px;">
...
<div style="position:inherit; border: solid 1px #CCC; width:100%; height:524px;background-color:#FFF;">
	...
	<div style="position:relative; border-right: solid 1px #CCC;top:5px;width:350px;height:30px;text-align:left;display:table-cell;font:0.7em sans-serif;color:#333;">
	...
	<div style="position:relative; border: solid 0px #CCC;top:5px;width:495px;height:30px;text-align:right;display:table-cell; vertical-align:bottom;">
	 ...
	 <div style="position:relative; border: solid 1px #CCC;top:10px;width:890px;height:478px;">
...
?>
    ...
    <div style="position:absolute; top:153px; left:5px; vertical-align:top; text-align:left;border: solid 0px #CCC;	">
        ...
        <button class="btnStandar" id="btnDoSearch" title="START SEARCHING" onclick="klikBtnCari();return false;">
        ...
        <button class="btnStandarDis" id="btnGetResult" title="" onclick="klikBtnResult();return false;" disabled>
    ...
    <div style="position:absolute; border: solid 1px #CCC; top:184px; left:5px; width:462px; height:303px; text-align:left;">        
        <iframe width="100%" height="100%" src="../templates/halCariList.php" target="iframeList" name="iframeList" id="iframeList" frameborder="0" marginwidth="0" marginheight="0" scrolling="yes"></iframe>
    </div>
