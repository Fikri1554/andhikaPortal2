...
function setup()
{
	...
	{
		if(eInvno.keyCode == 222 || eInvno.keyCode == 192)// UNTUK CHAR TANDA KUTIP (")(')
		{
			return false;
		}
	});
...
/*	var numParser4 = new NumberParser(2, ".", ",", true);
        ...
        var numMask4 = new NumberMask(numParser4, "amount", 12);*/

	/*$(document).ready(function()
	{		
		$(this).mouseover(function(e)
		{
			var idActElem = $(document.activeElement).prop("id");
