...
<?php
	...
	<tr id=\"".$i."\" bgcolor=\"#F0F1FF\" ".$trMouseOver.">
		<td>
			<table width=\"".$width."\" cellpadding=\"0\" cellspacing=\"0\" class=\"tabelBorderBottomJust\">
	...
	if($i !=  $jmlRow)
	{		
		$tabelaa.="<tr><td colspan=\"9\" class=\"tabelBorderBottomJust\" style=\"border-style:dotted;\" height=\"5\" bgcolor=\"#FFFFFF\"></td></tr>";
	}
	$tabelaa.="</table>
		</td>
	</tr>
