...
{
	$idVoucherGet = $_GET['idVoucher'];
	$changeYearGet = $_GET['changeYear'];
	$yearGet = $_GET['year'];
	$batchno = $CVoucher->detilVoucher($idVoucherGet, "batchno");
	
	$klikBtnClose = "parent.closePopup('".$idVoucherGet."');return false;";
	if($changeYearGet == "Y")
	{
		$klikBtnClose = "parent.chooseYear('".$yearGet."');return false;";
	}
?>
	 <div style="position:inherit; border: solid 1px #CCC; width:100%; height:174px; text-align:center; background-color:#FFF;">
        ...
        <div style="position:relative; top:10px;">
            <button class="btnStandar" id="" title="CLOSED" onclick="<?php echo $klikBtnClose; ?>">
                <table width="75" height="40">
                <tr>
                    <td align="center" width="20"><img src="../picture/door-open-out.png"/></td>
                    <td align="left">CLOSED</td> 
...
if($aksiGet == "descLargeView")
{
	...
	$amount = "( ".$CVoucher->detilVoucher($idVoucherGet, "currency")." )&nbsp;&nbsp;".$amountParent;
	
	$imgWarning = "";
	$warnaAmount = "color:#333;";
	if($CVoucher->detilVoucher($idVoucherGet, "amount") < 0)
	{
		$warnaAmount = "color:#C00;";
...
?>
    ...
    BATCHNO : <span style="font-size:12px;color:#096;font-weight:bold;"><?php echo $CPublic->zerofill($batchnoGet, 6); ?></span><br>
    ...
    &nbsp;BOOK STATUS : <span style="text-decoration:underline;font-size:11px;color:#096;font-weight:bold;"><?php echo strtoupper($bookSts); ?></span><br>
    &nbsp;AMOUNT : <span id="spanAmount" style="<?php echo $warnaAmount; ?>"><b><?php echo $amount.$imgWarning; ?></b></span>
    </div>
	...
	<div style="position:absolute; top:5px; left:5px; vertical-align:top; text-align:left;border: solid 1px #CCC;">
        ...
        <tr>
            ...
            <td class="elementTeks">
            	<select id="cariBerdasarkan" name="cariBerdasarkan" class="elementMenu" style="width:110px;" onchange="return false;">
        ...
        <tr valign="middle">
            <td width="90" height="42" class="">&nbsp;</td>
